...
enum {
    ...
    MYLITE_EXECUTION_STATEMENT_CACHE_LIMIT = 64,
};
...
enum mylite_session_internal_tmp_mem_storage_engine {
    MYLITE_SESSION_INTERNAL_TMP_MEM_STORAGE_ENGINE_TEMPTABLE = 0,
...
struct mylite_db {
    ...
    uint64_t table_key_metadata_cache_clock;
#ifdef MYLITE_ENABLE_PROFILING
