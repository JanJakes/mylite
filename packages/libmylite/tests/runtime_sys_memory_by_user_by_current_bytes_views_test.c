...
enum {
    ...
    memory_by_user_by_current_bytes_column_count = 6,
    ...
    memory_by_user_by_current_bytes_view_table_usage_row_count = 2,
...
static int test_sys_memory_by_user_by_current_bytes_views(void);
...
static const char
    *const memory_by_user_by_current_bytes_columns[memory_by_user_by_current_bytes_column_count] = {
        "user",
        "current_count_used",
        "current_allocated",
        "current_avg_alloc",
...
int main(void) {
    return test_sys_memory_by_user_by_current_bytes_views() == 0 ? 0 : 1;
}
...
static int test_sys_memory_by_user_by_current_bytes_views(void) {
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT * FROM sys.memory_by_user_by_current_bytes",
            .column_names = memory_by_user_by_current_bytes_columns,
            .column_count = memory_by_user_by_current_bytes_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys memory by user current bytes rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT * FROM sys.`x$memory_by_user_by_current_bytes`",
            .column_names = memory_by_user_by_current_bytes_columns,
            .column_count = memory_by_user_by_current_bytes_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys x memory by user current bytes rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys memory by user current bytes row_count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.memory_by_user_by_current_bytes",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys memory by user current bytes count",
        }
    );
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM memory_by_user_by_current_bytes",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys memory by user current bytes selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM `x$memory_by_user_by_current_bytes`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys x memory by user current bytes selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM memory_by_user_by_current_bytes",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = formatted_show_columns_values,
            .row_count = memory_by_user_by_current_bytes_column_count,
            .context = "sys memory by user current bytes show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "DESCRIBE `x$memory_by_user_by_current_bytes`",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = raw_show_columns_values,
            .row_count = memory_by_user_by_current_bytes_column_count,
            .context = "sys x memory by user current bytes describe",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM memory_by_user_by_current_bytes",
            ...
            .row_count = memory_by_user_by_current_bytes_column_count,
            .context = "sys memory by user current bytes show full columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM `x$memory_by_user_by_current_bytes`",
            .column_names = show_full_columns_columns,
            .column_count = show_full_columns_column_count,
            .values = raw_show_full_columns_values,
            .row_count = memory_by_user_by_current_bytes_column_count,
            .context = "sys x memory by user current bytes show full columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM memory_by_user_by_current_bytes",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys memory by user current bytes show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM `x$memory_by_user_by_current_bytes`",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys x memory by user current bytes show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_NAME, COLUMN_NAME, ORDINAL_POSITION, IS_NULLABLE, "
                   ...
                   "AND TABLE_NAME IN ('memory_by_user_by_current_bytes', "
                   "'x$memory_by_user_by_current_bytes') "
                   "ORDER BY TABLE_NAME",
            ...
            .context = "sys memory by user current bytes information_schema.columns rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_six,
            .row_count = 1U,
            .context = "sys memory by user current bytes information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_twelve,
            .row_count = 1U,
            .context = "sys memory by user current bytes information_schema.columns combined count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 2U,
            .context = "sys memory by user current bytes information_schema.tables rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'memory_by_user_by_current_bytes'",
            ...
            .row_count = 1U,
            .context = "sys memory by user current bytes show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'x$memory_by_user_by_current_bytes'",
            .column_names = show_table_status_columns,
            .column_count = show_table_status_column_count,
            .values = raw_show_table_status_values,
            .row_count = 1U,
            .context = "sys x memory by user current bytes show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_SCHEMA, TABLE_NAME, CHECK_OPTION, IS_UPDATABLE, DEFINER, "
                   ...
                   "AND TABLE_NAME IN ('memory_by_user_by_current_bytes', "
                   "'x$memory_by_user_by_current_bytes') ORDER BY TABLE_NAME",
            ...
            .row_count = 2U,
            .context = "sys memory by user current bytes information_schema.views rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT VIEW_SCHEMA, VIEW_NAME, TABLE_SCHEMA, TABLE_NAME "
                   ...
                   "AND VIEW_NAME IN ('memory_by_user_by_current_bytes', "
                   "'x$memory_by_user_by_current_bytes') "
                   "ORDER BY VIEW_NAME",
            ...
            .row_count = memory_by_user_by_current_bytes_view_table_usage_row_count,
            .context = "sys memory by user current bytes view_table_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = NULL,
            .row_count = 0U,
            .context = "sys memory by user current bytes empty view_routine_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys memory by user current bytes empty statistics",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys memory by user current bytes empty constraints",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys memory by user current bytes empty key column usage",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys memory by user current bytes empty constraint extensions",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW memory_by_user_by_current_bytes",
            ...
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL "
                      "SECURITY INVOKER VIEW `memory_by_user_by_current_bytes`",
            .context = "sys memory by user current bytes show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW `x$memory_by_user_by_current_bytes`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL "
                      "SECURITY INVOKER VIEW `x$memory_by_user_by_current_bytes`",
            .context = "sys x memory by user current bytes show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE sys.memory_by_user_by_current_bytes",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL "
                      "SECURITY INVOKER VIEW `sys`.`memory_by_user_by_current_bytes`",
            .context = "sys memory by user current bytes qualified show create table",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE `x$memory_by_user_by_current_bytes`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "from `performance_schema`.`memory_summary_by_user_by_event_name` "
                      "group by",
            .context = "sys x memory by user current bytes show create source",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW sys.memory_by_user_by_current_bytes",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "order by sum(`performance_schema`.`memory_summary_by_user_by_event_name`."
                      "`CURRENT_NUMBER_OF_BYTES_USED`) desc",
            .context = "sys memory by user current bytes show create ordering",
        }
    );
...
static int make_test_path(char *path, size_t path_size, const char *name) {
    int written = snprintf(
        path,
        path_size,
        "/tmp/mylite_runtime_sys_memory_by_user_by_current_bytes_views_%d_%s.mylite",
        current_process_id(),
        name
    );
