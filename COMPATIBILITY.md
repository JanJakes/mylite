...
| `CREATE SPATIAL REFERENCE SYSTEM` | ❌ | medium | Spatial reference system catalog DDL. | Parser recognizes numeric SRS ids, bare, `IF NOT EXISTS`, `OR REPLACE`, and documented text-string SRS attribute syntax with quoted hex/bit rejection and numeric organization authority codes. |
