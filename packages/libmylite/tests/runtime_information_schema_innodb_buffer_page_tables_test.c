...
static const struct expected_information_schema_column buffer_page_columns[] = {
    ...
    {"TABLE_NAME", "YES", "varchar", "341", "1024", "utf8mb3", "utf8mb3_general_ci", "varchar(1024)"
    },
    {"INDEX_NAME", "YES", "varchar", "341", "1024", "utf8mb3", "utf8mb3_general_ci", "varchar(1024)"
    },
...
static int expect_columns_metadata(
    ...
    failures += mylite_test_expect_int(rc, MYLITE_OK, "buffer page columns metadata");
    if (rc != MYLITE_OK) {
