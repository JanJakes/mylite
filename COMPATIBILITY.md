...
| `DATE()` | ❌ | top | Extract the date part of a date or datetime expression | Deferred; extraction/conversion functions are outside the current-temporal statement-clock slice. See [current temporal functions spec](docs/specs/current-temporal-functions/specs.md). |
