# Baseline mysql HELP tables tasks

- [x] Record official MySQL 8.4 documentation references for server-side HELP
  support and the HELP statement.
- [x] Probe MySQL 8.4.9 for direct row counts, metadata, indexes,
  constraints, and table status.
- [x] Specify the MyLite scope as empty read-only metadata placeholders without
  bundled manual/help content.
...
- [x] Implement mysql HELP table definitions and secondary unique index
  metadata.
