# Baseline mysql.global_grants table tasks
...
- [x] Specify the MyLite scope as an empty read-only metadata placeholder
  without dynamic privilege storage or enforcement.
...
- [x] Implement the `mysql.global_grants` table definition and primary-key
  metadata.
