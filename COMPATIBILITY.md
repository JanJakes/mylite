...
| `KILL` | ❌ | medium | Connection/query kill syntax and diagnostics. | Parser records numeric processlist id targets and distinguishes `KILL QUERY` from connection termination; termination behavior and privilege diagnostics are not implemented. |
