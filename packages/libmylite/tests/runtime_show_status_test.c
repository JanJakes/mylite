...
static const struct expected_status_row expected_session_rows[] = {
    ...
    {"Innodb_redo_log_uuid", "0"},
    {"Innodb_redo_log_checkpoint_lsn", "0"},
    {"Innodb_redo_log_current_lsn", "0"},
    {"Innodb_redo_log_flushed_to_disk_lsn", "0"},
    {"Innodb_redo_log_logical_size", "0"},
    {"Innodb_redo_log_physical_size", "0"},
    {"Innodb_redo_log_capacity_resized", "0"},
    ...
    {"Innodb_num_open_files", "0"},
    {"Innodb_truncated_status_writes", "0"},
    {"Innodb_undo_tablespaces_total", "0"},
    {"Innodb_undo_tablespaces_implicit", "0"},
...
static int test_show_status_values_scopes_and_filters(void) {
    ...
    static const struct expected_status_row expected_innodb_rows[] = {
        {"Innodb_buffer_pool_dump_status", "Dumping of buffer pool not started"},
        {"Innodb_buffer_pool_load_status", ""},
        {"Innodb_buffer_pool_resize_status", ""},
        {"Innodb_buffer_pool_resize_status_code", "0"},
    ...
    static const struct expected_status_row expected_mysqlx_rows[] = {
        {"Mysqlx_aborted_clients", "0"},
        {"Mysqlx_address", "UNDEFINED"},
        {"Mysqlx_bytes_received", "0"},
        {"Mysqlx_bytes_received_compressed_payload", "0"},
    ...
    failures += expect_status_rows(
        ...
        expected_innodb_rows,
        sizeof(expected_innodb_rows) / sizeof(expected_innodb_rows[0]),
        "show status innodb placeholders"
    );
    failures += expect_status_rows(
        database,
        ...
        expected_innodb_rows,
        sizeof(expected_innodb_rows) / sizeof(expected_innodb_rows[0]),
        "show session status innodb placeholders"
    );
    failures += expect_status_rows(
        database,
        "SHOW LOCAL STATUS LIKE 'Innodb%'",
        expected_innodb_rows,
        sizeof(expected_innodb_rows) / sizeof(expected_innodb_rows[0]),
        "show local status innodb placeholders"
    );
    failures += expect_status_rows(
        database,
        ...
        expected_innodb_rows,
        sizeof(expected_innodb_rows) / sizeof(expected_innodb_rows[0]),
        "show global status innodb placeholders"
    );
    failures += expect_status_rows(
        database,
    ...
    failures += expect_status_rows(
        ...
        expected_mysqlx_rows,
        sizeof(expected_mysqlx_rows) / sizeof(expected_mysqlx_rows[0]),
        "show status mysqlx placeholders"
    );
    failures += expect_status_rows(
        database,
        "SHOW SESSION STATUS LIKE 'Mysqlx%'",
        expected_mysqlx_rows,
        sizeof(expected_mysqlx_rows) / sizeof(expected_mysqlx_rows[0]),
        "show session status mysqlx placeholders"
    );
    failures += expect_status_rows(
        database,
        "SHOW LOCAL STATUS LIKE 'Mysqlx%'",
        expected_mysqlx_rows,
        sizeof(expected_mysqlx_rows) / sizeof(expected_mysqlx_rows[0]),
        "show local status mysqlx placeholders"
    );
    failures += expect_status_rows(
        database,
        "SHOW GLOBAL STATUS LIKE 'Mysqlx%'",
        expected_mysqlx_rows,
        sizeof(expected_mysqlx_rows) / sizeof(expected_mysqlx_rows[0]),
        "show global status mysqlx placeholders"
    );
    failures += expect_single_status_row(
        database,
