...
void mylite_sql_ast_node_set_parameter_index(struct mylite_sql_ast_node *node, size_t index) {
    ...
    node->payload.parameter.index = index;
}
...
size_t mylite_sql_ast_node_parameter_index(const struct mylite_sql_ast_node *node) {
    if (node == NULL || node->kind != MYLITE_SQL_AST_PARAMETER) {
        return SIZE_MAX;
    }

    return node->payload.parameter.index;
}
...
const char *mylite_sql_ast_node_kind_name(enum mylite_sql_ast_node_kind kind) {
    ...
    case MYLITE_SQL_AST_TIMESTAMP_FUNCTION:
        return "timestamp_function";
    case MYLITE_SQL_AST_TIMESTAMP_ARGUMENT_COUNT_ERROR:
        return "timestamp_argument_count_error";
    ...
    case MYLITE_SQL_AST_JSON_DEPTH_FUNCTION:
        return "json_depth_function";
    case MYLITE_SQL_AST_JSON_DEPTH_ARGUMENT_COUNT_ERROR:
        return "json_depth_argument_count_error";
    ...
    case MYLITE_SQL_AST_SOUNDEX_FUNCTION:
        return "soundex_function";
    case MYLITE_SQL_AST_SOUNDEX_ARGUMENT_COUNT_ERROR:
        return "soundex_argument_count_error";
    ...
    case MYLITE_SQL_AST_CHECKSUM_TABLE_STATEMENT:
        return "checksum_table_statement";
    ...
    case MYLITE_SQL_AST_GROUP_CONCAT_DISTINCT_MODIFIER:
        return "group_concat_distinct_modifier";
    case MYLITE_SQL_AST_AGGREGATE_DISTINCT_MODIFIER:
        return "aggregate_distinct_modifier";
    ...
    case MYLITE_SQL_AST_COUNT_EXPRESSION_FUNCTION:
        return "count_expression_function";
    ...
    case MYLITE_SQL_AST_SHOW_RELAYLOG_EVENTS_STATEMENT:
        return "show_relaylog_events_statement";
    ...
    case MYLITE_SQL_AST_SHOW_REPLICAS_STATEMENT:
        return "show_replicas_statement";
    ...
    case MYLITE_SQL_AST_ADMIN_NOOP_STATEMENT:
