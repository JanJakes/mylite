# Baseline Grouped GROUP_CONCAT Aggregate Alias HAVING Tasks
...
- [x] Add MySQL 8.4.9 expectation coverage for selected alias `HAVING`.
- [x] Add runtime C coverage for selected alias `HAVING`.
- [x] Keep direct `HAVING GROUP_CONCAT(...)` predicates unsupported for this slice.
