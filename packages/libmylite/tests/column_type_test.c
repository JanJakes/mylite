...
static int describe_temporal_type(
    const char *type_name,
    struct mylite_column_type_attributes attributes,
    enum mylite_column_type_status expected_status,
    struct mylite_column_type_descriptor *out_descriptor
...
static int test_integer_type_metadata(void) {
    ...
    failures += expect_uint(
        descriptor.numeric_precision,
        bigint_signed_precision,
...
static int test_string_binary_type_metadata(void) {
    ...
    failures += describe_string_binary_type(
        "CHAR",
        length_attribute(char_four_length),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    failures += expect_string(descriptor.column_type, "char(4)", "char(4) column type");
    failures += expect_uint64(
        descriptor.character_octet_length,
        utf8mb4_char_four_octets,
        "char(4) octets"
    );
...
static int test_string_binary_aliases_and_charsets(void) {
    ...
    failures += describe_string_binary_type(
        "CHAR",
        character_set_attribute("latin1"),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    ...
    failures += describe_string_binary_type(
        "CHAR",
        collation_attribute("latin1_swedish_ci"),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    ...
    failures += describe_string_binary_type(
        "CHAR",
        collation_attribute("utf8mb4_unicode_520_ci"),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    failures +=
    ...
    failures += describe_string_binary_type(
        "CHAR",
        collation_attribute("utf8mb4_unicode_ci"),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    failures += expect_string(descriptor.character_set_name, "utf8mb4", "unicode implied charset");
    failures += expect_string(descriptor.collation_name, "utf8mb4_unicode_ci", "unicode collation");

    failures += describe_string_binary_type(
        "CHAR",
        collation_attribute("binary"),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    ...
    failures += expect_bool(
        descriptor.character_set_name == NULL,
        true,
    ...
    failures += expect_bool(
        descriptor.is_deprecated_binary_attribute,
        true,
...
static int test_text_blob_length_mapping(void) {
    ...
    failures += describe_string_binary_type(
        "TEXT",
        length_attribute(text_utf8mb4_tiny_boundary),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    ...
    failures += describe_string_binary_type(
        "TEXT",
        length_attribute(text_utf8mb4_regular_boundary),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    ...
    failures += describe_string_binary_type(
        "BLOB",
        length_attribute(text_latin1_tiny_boundary),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    ...
    failures += describe_string_binary_type(
        "BLOB",
        length_attribute(char_binary_overflow_length),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    ...
    failures += describe_string_binary_type(
        "BLOB",
        length_attribute(regular_overflow_length),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
    ...
    failures += describe_string_binary_type(
        "BLOB",
        length_attribute(medium_overflow_length),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    );
...
static int test_numeric_type_metadata(void) {
    ...
    failures += describe_numeric_type(
        "DECIMAL",
        no_column_type_attributes(),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    ...
    failures += expect_uint(
        descriptor.numeric_precision,
        (unsigned int)float_precision_double_min,
...
static int test_temporal_type_metadata(void) {
    ...
    failures += describe_temporal_type(
        "DATE",
        no_column_type_attributes(),
        MYLITE_COLUMN_TYPE_OK,
        &descriptor
    ...
    failures += expect_uint(
        ...
        datetime_base_storage_bytes + 3U,
        "datetime(6) storage"
    );
    ...
    failures += expect_uint(
        descriptor.storage_bytes,
        timestamp_base_storage_bytes + 1U,
        "timestamp(1) storage"
    );
...
static int test_rejected_type_descriptors(void) {
    ...
    failures += describe_type(
        ...
        MYLITE_COLUMN_TYPE_DISPLAY_WIDTH_OUT_OF_RANGE,
        &descriptor
    );
    failures += describe_type(
        "BOOL",
    ...
    failures += describe_string_binary_type(
        "CHAR",
        length_attribute(char_binary_overflow_length),
        MYLITE_COLUMN_TYPE_LENGTH_OUT_OF_RANGE,
        &descriptor
    );
    failures += describe_string_binary_type(
        "BINARY",
    ...
    failures += describe_string_binary_type(
        "VARCHAR",
        length_attribute(varchar_utf8mb4_overflow_length),
        MYLITE_COLUMN_TYPE_LENGTH_OUT_OF_RANGE,
        &descriptor
    );
    failures += describe_string_binary_type(
    ...
    failures += describe_string_binary_type(
        "TEXT",
        length_attribute(blob_text_overflow_length),
        MYLITE_COLUMN_TYPE_LENGTH_OUT_OF_RANGE,
        &descriptor
    );
    failures += describe_string_binary_type(
        "TINYTEXT",
        length_attribute(char_default_length),
        MYLITE_COLUMN_TYPE_INVALID_SYNTAX,
        &descriptor
    );
    failures += describe_string_binary_type(
    ...
    failures += describe_numeric_type(
        ...
        MYLITE_COLUMN_TYPE_SCALE_OUT_OF_RANGE,
        &descriptor
    );
    failures += describe_numeric_type(
        "DECIMAL",
        ...
        MYLITE_COLUMN_TYPE_SCALE_EXCEEDS_PRECISION,
        &descriptor
    );
    failures += describe_numeric_type(
        "DECIMAL",
...

    {
        ...
        failures += describe_string_binary_type(
            "CHAR",
            mismatch,
            MYLITE_COLUMN_TYPE_COLLATION_CHARACTER_SET_MISMATCH,
            &descriptor
        );
    }
