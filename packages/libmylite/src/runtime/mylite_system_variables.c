...
enum mylite_system_variable_id {
    ...
    MYLITE_SYSTEM_VARIABLE_DEFAULT_COLLATION_FOR_UTF8MB4 = 12,
    MYLITE_SYSTEM_VARIABLE_DEFAULT_STORAGE_ENGINE = 13,
    MYLITE_SYSTEM_VARIABLE_ERROR_COUNT = 14,
    MYLITE_SYSTEM_VARIABLE_FOREIGN_KEY_CHECKS = 15,
    MYLITE_SYSTEM_VARIABLE_GROUP_CONCAT_MAX_LEN = 16,
    MYLITE_SYSTEM_VARIABLE_LAST_INSERT_ID = 17,
    MYLITE_SYSTEM_VARIABLE_LOWER_CASE_TABLE_NAMES = 18,
    MYLITE_SYSTEM_VARIABLE_MAX_ALLOWED_PACKET = 19,
    MYLITE_SYSTEM_VARIABLE_MAX_CONNECTIONS = 20,
    MYLITE_SYSTEM_VARIABLE_MAX_ERROR_COUNT = 21,
    MYLITE_SYSTEM_VARIABLE_SQL_MODE = 22,
    MYLITE_SYSTEM_VARIABLE_SQL_NOTES = 23,
    MYLITE_SYSTEM_VARIABLE_TIME_ZONE = 24,
    MYLITE_SYSTEM_VARIABLE_TRANSACTION_ISOLATION = 25,
    MYLITE_SYSTEM_VARIABLE_TRANSACTION_READ_ONLY = 26,
    MYLITE_SYSTEM_VARIABLE_UNIQUE_CHECKS = 27,
    MYLITE_SYSTEM_VARIABLE_VERSION = 28,
    MYLITE_SYSTEM_VARIABLE_VERSION_COMMENT = 29,
    MYLITE_SYSTEM_VARIABLE_VERSION_COMPILE_MACHINE = 30,
    MYLITE_SYSTEM_VARIABLE_VERSION_COMPILE_OS = 31,
    MYLITE_SYSTEM_VARIABLE_VERSION_COMPILE_ZLIB = 32,
    MYLITE_SYSTEM_VARIABLE_WAIT_TIMEOUT = 33,
    MYLITE_SYSTEM_VARIABLE_WARNING_COUNT = 34,
    MYLITE_SYSTEM_VARIABLE_GTID_PURGED = 35,
    MYLITE_SYSTEM_VARIABLE_LOG_BIN = 36,
...
static const struct mylite_system_variable_entry *find_system_variable_entry(
    ...
    static const struct mylite_system_variable_entry entries[] = {
        ...
        {"default_collation_for_utf8mb4",
         MYLITE_SYSTEM_VARIABLE_DEFAULT_COLLATION_FOR_UTF8MB4,
         MYLITE_SYSTEM_VARIABLE_SUPPORT_BOTH,
         MYLITE_SYSTEM_VARIABLE_VALUE_STRING},
...
static uint64_t system_variable_unsigned_value(
    ...
    case MYLITE_SYSTEM_VARIABLE_DEFAULT_COLLATION_FOR_UTF8MB4:
...
static const char *system_variable_string_value(
    ...
    case MYLITE_SYSTEM_VARIABLE_DEFAULT_COLLATION_FOR_UTF8MB4:
        if (global) {
            return mylite_connection_default_collation_for_utf8mb4();
        }
        return mylite_connection_collation_for_utf8mb4(database);
    case MYLITE_SYSTEM_VARIABLE_DEFAULT_STORAGE_ENGINE:
        if (global) {
