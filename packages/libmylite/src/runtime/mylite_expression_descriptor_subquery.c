...
int mylite_expression_descriptor_infer_subquery_expression(
    ...
    case MYLITE_SQL_AST_SUBQUERY_EXPRESSION:
        return infer_scalar_subquery_expression_descriptor(
            database,
            expression,
            out_descriptor,
            callbacks
    ...
    case MYLITE_SQL_AST_QUANTIFIED_COMPARISON:
        return infer_quantified_subquery_expression_descriptor(
            database,
            plan,
            expression,
            out_descriptor,
...
int mylite_expression_descriptor_infer_binary_subquery_expression(
    ...
    if (mylite_select_subquery_binary_expression_is_row(expression)) {
        ...
        return infer_row_subquery_expression_descriptor(
            database,
            plan,
            expression,
            out_descriptor,
    ...
    if (mylite_select_subquery_binary_expression_is_in(expression)) {
        ...
        return infer_in_subquery_expression_descriptor(
            database,
            plan,
            expression,
            out_descriptor,
...
static int infer_scalar_subquery_expression_descriptor(
    ...
    if (from_clause == NULL || from_clause->kind == MYLITE_SQL_AST_FROM_DUAL) {
        return callbacks
            ->infer_expression_descriptor(database, NULL, select_expression, NULL, out_descriptor);
    }
...
static int infer_in_subquery_expression_descriptor(
    ...
    status = mylite_select_subquery_bind_in_expression(
        database,
        expression,
        plan,
...
static int infer_row_subquery_expression_descriptor(
    ...
    status = mylite_select_subquery_bind_row_expression(
        database,
        expression,
        plan,
        callbacks->bind_callbacks
...
static int infer_quantified_subquery_expression_descriptor(
    ...
    status = mylite_select_subquery_bind_quantified_expression(
        database,
        expression,
        plan,
        callbacks->bind_callbacks
