...
| `GET DIAGNOSTICS` | ❌ | medium | Current and stacked diagnostics retrieval. | Parser accepts statement and condition-item forms and records explicit diagnostics condition-area indexes; diagnostics storage and assignment semantics are not implemented. |
