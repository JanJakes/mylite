# Baseline sys.io_global_by_wait_by_bytes views tasks

- [x] Record official MySQL 8.4 documentation references for the sys
      wait-bytes view surface, Performance Schema file summary source, and
...
- [x] Specify empty placeholder behavior and intentionally unsupported live
      file-summary byte rows grouped by event.
