...
enum {
    ...
    information_schema_view_table_usage_row_count = 3,
...
static int test_sys_ps_digest_helper_views(void);
...
static const char *const avg_latency_columns[avg_latency_column_count] = {
    "cnt",
    "avg_us",
};

static const char *const percentile_columns[percentile_column_count] = {
    "avg_us",
    "percentile",
};
...
int main(void) {
    return test_sys_ps_digest_helper_views() == 0 ? 0 : 1;
}
...
static int test_sys_ps_digest_helper_views(void) {
    ...
    static const char *const avg_latency_show_columns_values[] = {
        "cnt",
        "bigint",
        "NO",
        "",
    ...
    static const char *const percentile_show_columns_values[] = {
        "avg_us",
        "decimal(21,0)",
        "YES",
        "",
    ...
    static const char *const avg_latency_show_full_columns_values[] = {
        "cnt",
        "bigint",
        NULL,
        "NO",
    ...
    static const char *const percentile_show_full_columns_values[] = {
        "avg_us",
        "decimal(21,0)",
        NULL,
        "YES",
    ...
    static const char *const avg_latency_show_table_status_values[] = {
        "x$ps_digest_avg_latency_distribution",
        NULL,
        NULL,
        NULL,
    ...
    static const char *const percentile_show_table_status_values[] = {
        "x$ps_digest_95th_percentile_by_avg_us",
        NULL,
        NULL,
        NULL,
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT * FROM sys.`x$ps_digest_avg_latency_distribution`",
            .column_names = avg_latency_columns,
            .column_count = avg_latency_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys digest avg latency rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT * FROM sys.`x$ps_digest_95th_percentile_by_avg_us`",
            .column_names = percentile_columns,
            .column_count = percentile_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys digest percentile rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys digest helper row_count",
        }
    );
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM `x$ps_digest_avg_latency_distribution`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys digest avg latency selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM `x$ps_digest_95th_percentile_by_avg_us`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys digest percentile selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM `x$ps_digest_avg_latency_distribution`",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = avg_latency_show_columns_values,
            .row_count = avg_latency_column_count,
            .context = "sys digest avg latency show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "DESCRIBE `x$ps_digest_95th_percentile_by_avg_us`",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = percentile_show_columns_values,
            .row_count = percentile_column_count,
            .context = "sys digest percentile describe",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM `x$ps_digest_avg_latency_distribution`",
            .column_names = show_full_columns_columns,
            .column_count = show_full_columns_column_count,
            .values = avg_latency_show_full_columns_values,
            .row_count = avg_latency_column_count,
            .context = "sys digest avg latency show full columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM `x$ps_digest_95th_percentile_by_avg_us`",
            .column_names = show_full_columns_columns,
            .column_count = show_full_columns_column_count,
            .values = percentile_show_full_columns_values,
            .row_count = percentile_column_count,
            .context = "sys digest percentile show full columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM `x$ps_digest_avg_latency_distribution`",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys digest avg latency show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM `x$ps_digest_95th_percentile_by_avg_us`",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys digest percentile show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_NAME, COLUMN_NAME, ORDINAL_POSITION, IS_NULLABLE, "
                   ...
                   "'x$ps_digest_95th_percentile_by_avg_us') ORDER BY TABLE_NAME, "
                   "ORDINAL_POSITION",
            ...
            .context = "sys digest helper information_schema.columns rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_four,
            .row_count = 1U,
            .context = "sys digest helper information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 2U,
            .context = "sys digest helper information_schema.tables rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = "
                   "'x$ps_digest_avg_latency_distribution'",
            .column_names = show_table_status_columns,
            .column_count = show_table_status_column_count,
            .values = avg_latency_show_table_status_values,
            .row_count = 1U,
            .context = "sys digest avg latency show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .column_names = show_table_status_columns,
            .column_count = show_table_status_column_count,
            .values = percentile_show_table_status_values,
            .row_count = 1U,
            .context = "sys digest percentile show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 2U,
            .context = "sys digest helper information_schema.views rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .context = "sys digest helper view_table_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = NULL,
            .row_count = 0U,
            .context = "sys digest helper empty view_routine_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys digest helper empty statistics",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys digest helper empty constraints",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys digest helper empty key column usage",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys digest helper empty constraint extensions",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW `x$ps_digest_avg_latency_distribution`",
            ...
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL "
                      "SECURITY INVOKER VIEW `x$ps_digest_avg_latency_distribution`",
            .context = "sys digest avg latency show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW `x$ps_digest_95th_percentile_by_avg_us`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL "
                      "SECURITY INVOKER VIEW `x$ps_digest_95th_percentile_by_avg_us`",
            .context = "sys digest percentile show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE sys.`x$ps_digest_avg_latency_distribution`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "from `performance_schema`.`events_statements_summary_by_digest` group "
                      "by `avg_us`",
            .context = "sys digest avg latency qualified show create source",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE sys.`x$ps_digest_95th_percentile_by_avg_us`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "`sys`.`x$ps_digest_avg_latency_distribution` `s1` join "
                      "`sys`.`x$ps_digest_avg_latency_distribution` `s2`",
            .context = "sys digest percentile qualified show create source",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_two,
            .row_count = 1U,
            .context = "sys digest helper information_schema.views count",
        }
    );
...
static int make_test_path(char *path, size_t path_size, const char *name) {
    int written = snprintf(
        path,
        path_size,
        "/tmp/mylite_runtime_sys_ps_digest_helper_views_%d_%s.mylite",
        current_process_id(),
        name
    );
