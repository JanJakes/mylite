...
System variables start with `@@` and continue through identifier characters and
dots. Scope validation (`GLOBAL`, `SESSION`, `LOCAL`, and similar forms)
belongs to later parser/analyzer layers.
