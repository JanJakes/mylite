# Baseline sys.io_by_thread_by_latency views tasks

- [x] Record official MySQL 8.4 documentation references for the sys
      io-by-thread latency view surface, Performance Schema wait summary
      source, Performance Schema thread source, and SHOW CREATE metadata.
...
- [x] Specify empty placeholder behavior and intentionally unsupported live
      thread and file-I/O wait-summary rows.
