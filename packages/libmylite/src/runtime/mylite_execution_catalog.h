...
enum mylite_execution_catalog_information_schema_table_kind {
    ...
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_APPLIER_CONFIGURATION = 253,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_APPLIER_FILTERS = 254,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_APPLIER_GLOBAL_FILTERS = 255,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_APPLIER_STATUS = 256,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_APPLIER_STATUS_BY_COORDINATOR =
        257,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_APPLIER_STATUS_BY_WORKER = 258,
    ...
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_ASYNCHRONOUS_CONNECTION_FAILOVER_MANAGED =
        260,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_CONNECTION_CONFIGURATION = 261,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_CONNECTION_STATUS = 262,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_GROUP_MEMBER_STATS = 263,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_REPLICATION_GROUP_MEMBERS = 264,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STAGES_CURRENT = 265,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY = 266,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG = 267,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG = 268,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_SUMMARY_BY_PROGRAM = 269,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_WAITS_CURRENT = 270,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY = 271,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG = 272,
    ...
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_WAITS_SUMMARY_BY_HOST_BY_EVENT_NAME =
        279,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_WAITS_SUMMARY_BY_INSTANCE = 280,
    ...
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_ERRORS_SUMMARY_BY_ACCOUNT_BY_ERROR =
        284,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_ERRORS_SUMMARY_BY_HOST_BY_ERROR = 285,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_ERRORS_SUMMARY_BY_THREAD_BY_ERROR =
        286,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_ERRORS_SUMMARY_BY_USER_BY_ERROR = 287,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_ERRORS_SUMMARY_GLOBAL_BY_ERROR = 288,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_FILE_SUMMARY_BY_EVENT_NAME = 289,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_FILE_SUMMARY_BY_INSTANCE = 290,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SOCKET_SUMMARY_BY_EVENT_NAME = 291,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SOCKET_SUMMARY_BY_INSTANCE = 292,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_MEMORY_SUMMARY_BY_ACCOUNT_BY_EVENT_NAME = 293,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_MEMORY_SUMMARY_BY_HOST_BY_EVENT_NAME = 294,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_MEMORY_SUMMARY_BY_THREAD_BY_EVENT_NAME = 295,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME = 296,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_MEMORY_SUMMARY_GLOBAL_BY_EVENT_NAME = 297,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_TABLE_IO_WAITS_SUMMARY_BY_INDEX_USAGE = 298,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_TABLE_IO_WAITS_SUMMARY_BY_TABLE = 299,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_TABLE_LOCK_WAITS_SUMMARY_BY_TABLE = 300,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_METADATA_LOCKS = 301,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_OBJECTS_SUMMARY_GLOBAL_BY_TYPE = 302,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_TLS_CHANNEL_STATUS = 303,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_CURRENT = 304,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTOGRAM_BY_DIGEST = 305,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTOGRAM_GLOBAL = 306,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY = 307,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_SUMMARY_BY_ACCOUNT_BY_EVENT_NAME =
        308,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_SUMMARY_BY_DIGEST = 309,
    ...
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_SUMMARY_GLOBAL_BY_EVENT_NAME =
        313,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_CURRENT = 314,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY = 315,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG = 316,
    ...
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_SUMMARY_GLOBAL_BY_EVENT_NAME =
        321,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_ERROR_LOG = 322,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_LOG_STATUS = 323,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SETUP_INSTRUMENTS = 324,
};
