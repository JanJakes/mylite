...
| `utf8mb4_0900_ai_ci` | 🟡 | Limited static `SHOW COLLATION` row, fixed `CREATE TABLE` option acceptance, and scalar `@@collation_connection` / `@@collation_server` reads; utf8mb4; id 255; default; sortlen 0; NO PAD; no comparison semantics |
