...
| `KILL` | ❌ | medium | Connection/query kill syntax and diagnostics. | Parser recognizes CONNECTION/QUERY modes and literal, local-variable, and user-variable targets. |
