...
expect_output_with_headers \
    ...
    "chosen	fallback	COALESCE (NULL,10)	(COALESCE(NULL,10))	COALESCE(NULL, COALESCE(NULL,1), 2)	COALESCE(IF(0,NULL,4),5)	IFNULL(COALESCE(NULL,NULL),9)	IF(COALESCE(NULL,0),1,2)
1	3	10	10	1	4	9	2" \
    "SELECT COALESCE(1,2) AS chosen, COALESCE(NULL,3) fallback, COALESCE (NULL,10), (COALESCE(NULL,10)), COALESCE(NULL, COALESCE(NULL,1), 2), COALESCE(IF(0,NULL,4),5), IFNULL(COALESCE(NULL,NULL),9), IF(COALESCE(NULL,0),1,2);" \
    "$DATABASE"
