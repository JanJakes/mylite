...
| `CLONE` | ❌ | low | Local and remote clone syntax and diagnostics. | Parser recognizes local clone and remote `CLONE INSTANCE` syntax, including numeric remote ports, text-string passwords and data directories with quoted hex/bit rejection, and SSL clauses. |
