...
- [ ] Align remaining numeric/string casts and coercions in strict and
      ...
      covered for strict and non-strict `INSERT ... VALUES`, `INSERT IGNORE`,
      strict and non-strict single-table `UPDATE`, and single-table
      `UPDATE IGNORE`, including UTF-8 boundary truncation for `MEDIUMTEXT`.
