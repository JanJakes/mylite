# Baseline sys.host_summary_by_file_io views tasks

- [x] Record official MySQL 8.4 documentation references for the sys host
      summary by file I/O view surface, Performance Schema wait-summary source,
      and SHOW CREATE metadata.
...
- [x] Specify empty placeholder behavior and intentionally unsupported live
      host/wait-summary and formatting-function behavior.
