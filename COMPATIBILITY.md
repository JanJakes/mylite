...
| `DATE_ADD()` | ❌ | top | Add time values (intervals) to a date value | Deferred; interval arithmetic is outside the current-temporal statement-clock slice. See [current temporal functions spec](docs/specs/current-temporal-functions/specs.md). |
