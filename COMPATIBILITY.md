...
| `SELECT ... INTO OUTFILE` | ❌ | medium | File export syntax and embedded-compatible diagnostics. | Parser requires a text-string file name with quoted hex/bit rejection and validates basic character-set, field, and line option tails; export execution is not implemented. |
