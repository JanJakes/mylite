# Baseline mysql.password_history table tasks
...
- [x] Specify the MyLite scope as an empty read-only metadata placeholder
  without password history storage or enforcement.
...
- [x] Implement the `mysql.password_history` table definition and index
  metadata.
