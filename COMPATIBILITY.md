...
| `SELECT ... INTO DUMPFILE` | ❌ | medium | Binary file export syntax and embedded-compatible diagnostics. | Parser accepts the form and records the literal export-file target; binary file I/O behavior is not implemented. |
