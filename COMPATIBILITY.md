...
| `*` | 🟡 | Specified for upcoming limited no-source/`DUAL` signed-64 scalar arithmetic projection only; not implemented yet, and no table-backed expression support. | [operators](docs/compatibility/operators.md), [SQL query expressions](docs/compatibility/sql-query-expressions.md) |
| `+` | 🟡 | Specified for upcoming limited no-source/`DUAL` signed-64 scalar arithmetic projection only; not implemented yet, and no table-backed expression support. | [operators](docs/compatibility/operators.md), [SQL query expressions](docs/compatibility/sql-query-expressions.md) |
| `-` (binary) | 🟡 | Specified for upcoming limited no-source/`DUAL` signed-64 scalar arithmetic projection only; not implemented yet, and no table-backed expression support. | [operators](docs/compatibility/operators.md), [SQL query expressions](docs/compatibility/sql-query-expressions.md) |
