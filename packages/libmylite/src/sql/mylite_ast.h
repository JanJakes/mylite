...
enum mylite_sql_ast_operator {
    ...
    MYLITE_SQL_AST_OPERATOR_IS_TRUE = 21,
    MYLITE_SQL_AST_OPERATOR_IS_NOT_TRUE = 22,
    MYLITE_SQL_AST_OPERATOR_IS_FALSE = 23,
    MYLITE_SQL_AST_OPERATOR_IS_NOT_FALSE = 24,
    MYLITE_SQL_AST_OPERATOR_IS_UNKNOWN = 25,
    MYLITE_SQL_AST_OPERATOR_IS_NOT_UNKNOWN = 26,
};
