#ifndef MYLITE_RUNTIME_MYLITE_EXPRESSION_DESCRIPTOR_COMPARE_H
#define MYLITE_RUNTIME_MYLITE_EXPRESSION_DESCRIPTOR_COMPARE_H
...
struct mylite_expression_descriptor_compare_callbacks {
...
int mylite_expression_descriptor_infer_greatest_least_function(
    ...
    const struct mylite_sql_ast_node *expression, bool result_nullable,
    struct mylite_field_descriptor *out_descriptor,
