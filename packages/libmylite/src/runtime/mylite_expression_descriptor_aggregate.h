#ifndef MYLITE_RUNTIME_MYLITE_EXPRESSION_DESCRIPTOR_AGGREGATE_H
#define MYLITE_RUNTIME_MYLITE_EXPRESSION_DESCRIPTOR_AGGREGATE_H
...
struct mylite_expression_descriptor_aggregate_callbacks {
