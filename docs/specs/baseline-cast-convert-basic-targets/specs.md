...
- deterministic rejection of unsupported `CHAR(N)`, explicit charset target
  clauses, table-backed casts, predicate casts, DML assignments, parameters,
  subqueries, and arbitrary expression operands;
