...
static int expect_delete_ok(mylite_db *database, const char *sql, int64_t affected_rows) {
    ...
    failures +=
        mylite_test_expect_size(mylite_result_column_count(result), 0U, "delete column count");
    failures += mylite_test_expect_size(mylite_result_row_count(result), 0U, "delete row count");
    ...
    failures +=
        mylite_test_expect_size(mylite_result_warning_count(result), 0U, "delete warning count");
    mylite_result_free(result);
