...
- [x] Add MySQL-runtime expectation script for supported behavior and deferred
  forms.
- [x] Update parser/AST support for `EXP`, `LN`, `LOG`, `LOG10`, `LOG2`,
  `POW`, and `POWER` with correct arity behavior.
- [x] Add runtime evaluation, formatting, warning, and overflow handling.
- [x] Add C parser/runtime coverage and CMake registration.
...
- [x] Review the final diff for MySQL behavior, warning/error ordering,
