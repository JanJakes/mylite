...
enum session_system_variable_kind {
    ...
    SESSION_SYSTEM_VARIABLE_SQL_SAFE_UPDATES = 23,
    SESSION_SYSTEM_VARIABLE_SQL_WARNINGS = 24,
    SESSION_SYSTEM_VARIABLE_SQL_SELECT_LIMIT = 25,
    SESSION_SYSTEM_VARIABLE_SQL_NOTES = 26,
    SESSION_SYSTEM_VARIABLE_SQL_BUFFER_RESULT = 27,
};
