...
enum {
    ...
    information_schema_columns_sample_row_count = 2,
...
static int test_sys_ps_check_lost_instrumentation_view(void);
...
static const char *const ps_check_columns[ps_check_column_count] = {
    "variable_name",
    "variable_value",
};
...
int main(void) {
    return test_sys_ps_check_lost_instrumentation_view() == 0 ? 0 : 1;
}
...
static int test_sys_ps_check_lost_instrumentation_view(void) {
    ...
    failures += expect_query(
        ...
        (struct expected_query){
            ...
            .column_names = ps_check_columns,
            .column_count = ps_check_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys.ps_check_lost_instrumentation direct rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation row_count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.ps_check_lost_instrumentation",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation count",
        }
    );
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM ps_check_lost_instrumentation",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation selected schema count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM ps_check_lost_instrumentation",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = show_columns_values,
            .row_count = ps_check_column_count,
            .context = "sys.ps_check_lost_instrumentation show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "DESCRIBE ps_check_lost_instrumentation",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = show_columns_values,
            .row_count = ps_check_column_count,
            .context = "sys.ps_check_lost_instrumentation describe",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM ps_check_lost_instrumentation",
            .column_names = show_full_columns_columns,
            .column_count = show_full_columns_column_count,
            .values = show_full_columns_values,
            .row_count = ps_check_column_count,
            .context = "sys.ps_check_lost_instrumentation show full columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM ps_check_lost_instrumentation",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys.ps_check_lost_instrumentation show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .context = "sys.ps_check_lost_instrumentation information_schema.columns rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation information_schema.tables row",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys LIKE 'ps_check_lost_instrumentation'",
            .column_names = show_table_status_columns,
            .column_count = show_table_status_column_count,
            .values = show_table_status_values,
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation information_schema.views row",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation view_table_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation empty view_routine_usage",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation empty statistics",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation empty table_constraints",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation empty key_column_usage",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.ps_check_lost_instrumentation empty table_constraints_extensions",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW ps_check_lost_instrumentation",
            ...
            .needle = "CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `ps_check_lost_instrumentation`",
            .context = "sys.ps_check_lost_instrumentation show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            ...
            .row_index = 0U,
            .column_index = 1U,
            .needle = "`performance_schema`.`global_status`.`VARIABLE_NAME` like 'perf%lost'",
            .context = "sys.ps_check_lost_instrumentation show create name filter",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE ps_check_lost_instrumentation",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "`performance_schema`.`global_status`.`VARIABLE_VALUE` > 0",
            .context = "sys.ps_check_lost_instrumentation show create value filter",
        }
    );
