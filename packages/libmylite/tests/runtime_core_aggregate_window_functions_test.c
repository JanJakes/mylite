...
static int test_core_aggregate_window_metadata(void) {
    ...
    if (failures == 0) {
        ...
        failures += mylite_test_expect_int(rc, MYLITE_OK, "aggregate window metadata query");
        if (rc != MYLITE_OK) {
    ...
    failures += mylite_test_expect_int(
        mylite_result_column_nullable(result, metadata_sum_column),
        1,
        "sum nullable"
    );
    failures += mylite_test_expect_int(
    ...
    failures += mylite_test_expect_int(
        mylite_result_column_nullable(result, metadata_avg_column),
        1,
        "avg nullable"
    );
    failures += mylite_test_expect_int(
    ...
    failures += mylite_test_expect_int(
        mylite_result_column_nullable(result, metadata_min_column),
        1,
        "min nullable"
    );
    failures += mylite_test_expect_int(
    ...
    failures += mylite_test_expect_int(
        mylite_result_column_nullable(result, metadata_max_column),
        1,
        "max nullable"
    );
