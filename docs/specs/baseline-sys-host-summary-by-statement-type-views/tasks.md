# Baseline sys.host_summary_by_statement_type views tasks

- [x] Record official MySQL 8.4 documentation references for the sys host
      summary by statement type view surface, Performance Schema statement
...
- [x] Specify empty placeholder behavior and intentionally unsupported live
      host statement type summary and formatting-function behavior.
