...
enum {
    ...
    storage_table_option_count = 11,
    storage_stats_auto_recalc_option_index = 5,
    storage_stats_sample_pages_option_index = 6,
    storage_min_rows_option_index = 7,
    storage_max_rows_option_index = 8,
    storage_avg_row_length_option_index = 9,
    storage_delay_key_write_option_index = 10,
