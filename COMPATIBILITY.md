...
| `SET` | ❌ | top | Variable assignment, user variables, system variables, persisted variables, names, charset, and transaction forms. | Parser records explicit user-variable and system-variable targets plus account-management targets; unadorned variable names remain semantic-analysis work. |
