...
| Scalar subqueries | ❌ | top | Single-value cardinality, NULL behavior, correlation, and errors. | Started; spec: [subqueries](docs/specs/subqueries/specs.md). |
...
| `EXISTS` subqueries | ❌ | top | Existence semantics and correlation behavior. | Started; spec: [subqueries](docs/specs/subqueries/specs.md). |
