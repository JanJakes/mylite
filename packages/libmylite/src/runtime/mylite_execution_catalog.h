...
enum mylite_execution_catalog_information_schema_table_kind {
    ...
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY = 202,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_X_WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY = 203,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_WAIT_CLASSES_GLOBAL_BY_LATENCY = 204,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_X_WAIT_CLASSES_GLOBAL_BY_LATENCY = 205,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_WAITS_BY_HOST_BY_LATENCY = 206,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_X_WAITS_BY_HOST_BY_LATENCY = 207,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_WAITS_BY_USER_BY_LATENCY = 208,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_X_WAITS_BY_USER_BY_LATENCY = 209,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_WAITS_GLOBAL_BY_LATENCY = 210,
    MYLITE_EXECUTION_CATALOG_TABLE_SYS_X_WAITS_GLOBAL_BY_LATENCY = 211,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_GLOBAL_STATUS = 212,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_GLOBAL_VARIABLES = 213,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SESSION_STATUS = 214,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SESSION_VARIABLES = 215,
    ...
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SETUP_THREADS = 220,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_USER_VARIABLES_BY_THREAD = 221,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_USER_DEFINED_FUNCTIONS = 222,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SETUP_LOGGERS = 223,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SETUP_METERS = 224,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SETUP_METRICS = 225,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_TABLE_HANDLES = 226,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_VARIABLES_BY_THREAD = 227,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_STATUS_BY_THREAD = 228,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_STATUS_BY_ACCOUNT = 229,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_STATUS_BY_HOST = 230,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_STATUS_BY_USER = 231,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_ACCOUNTS = 232,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_HOSTS = 233,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_USERS = 234,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_PROCESSLIST = 235,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_THREADS = 236,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SESSION_ACCOUNT_CONNECT_ATTRS = 237,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS = 238,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_PERSISTED_VARIABLES = 239,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_VARIABLES_INFO = 240,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_COND_INSTANCES = 241,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_FILE_INSTANCES = 242,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_MUTEX_INSTANCES = 243,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_RWLOCK_INSTANCES = 244,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_SOCKET_INSTANCES = 245,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_BINARY_LOG_TRANSACTION_COMPRESSION_STATS =
        246,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_DATA_LOCKS = 247,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_DATA_LOCK_WAITS = 248,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_PREPARED_STATEMENTS_INSTANCES = 249,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_HOST_CACHE = 250,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_KEYRING_COMPONENT_STATUS = 251,
    MYLITE_EXECUTION_CATALOG_TABLE_PERFORMANCE_SCHEMA_KEYRING_KEYS = 252,
};
