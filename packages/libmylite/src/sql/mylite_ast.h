...
enum mylite_sql_ast_node_kind {
    ...
    MYLITE_SQL_AST_JSON_SEARCH_FUNCTION = 768,
    MYLITE_SQL_AST_JSON_SEARCH_ARGUMENT_COUNT_ERROR = 769,
    MYLITE_SQL_AST_SHOW_ENGINE_LOGS_STATEMENT = 770,
    MYLITE_SQL_AST_ST_COLLECT_AGGREGATE_FUNCTION = 771,
    MYLITE_SQL_AST_ANY_SUBQUERY_PREDICATE = 772,
    MYLITE_SQL_AST_SOME_SUBQUERY_PREDICATE = 773,
    MYLITE_SQL_AST_ALL_SUBQUERY_PREDICATE = 774,
    MYLITE_SQL_AST_FROM_JSON_TABLE = 775,
    MYLITE_SQL_AST_JSON_TABLE_COLUMN_LIST = 776,
    MYLITE_SQL_AST_JSON_TABLE_ORDINALITY_COLUMN = 777,
    MYLITE_SQL_AST_JSON_TABLE_PATH_COLUMN = 778,
