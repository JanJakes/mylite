...
static const struct mylite_execution_catalog_mysql_system_table
    sys_core_system_table_definitions[] = {
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_sys_config_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_sys_config_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_sys_config_column_privileges),
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_version_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_version_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_version_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_metrics_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_metrics_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_metrics_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_processlist_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_processlist_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_processlist_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_session_ssl_status_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_session_ssl_status_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_session_ssl_status_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
