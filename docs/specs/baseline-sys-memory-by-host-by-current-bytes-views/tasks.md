# Baseline sys.memory_by_host_by_current_bytes views tasks

- [x] Record official MySQL 8.4 documentation references for the sys memory
      by-host view surface, Performance Schema source, and SHOW CREATE
      metadata.
...
- [x] Specify empty placeholder behavior and intentionally unsupported live
      Performance Schema memory-summary behavior.
