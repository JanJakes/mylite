...
typedef int (*mylite_dml_mutation_unknown_column_error_fn)(mylite_db *database,
                                                           const char *column_name,
                                                           const char *clause_context);
typedef int (*mylite_dml_mutation_unsupported_clause_error_fn)(mylite_db *database);
typedef int (*mylite_dml_mutation_unsupported_expression_error_fn)(mylite_db *database,
                                                                   const char *clause_context);
