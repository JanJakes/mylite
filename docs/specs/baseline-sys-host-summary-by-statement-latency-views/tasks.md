# Baseline sys.host_summary_by_statement_latency views tasks

- [x] Record official MySQL 8.4 documentation references for the sys host
      summary by statement latency view surface, Performance Schema statement
      summary source, and SHOW CREATE metadata.
...
- [x] Specify empty placeholder behavior and intentionally unsupported live
      host statement summary and formatting-function behavior.
