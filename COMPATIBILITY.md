...
| `KILL` | ❌ | medium | Connection/query kill syntax and diagnostics. | Parser recognizes `CONNECTION`/`QUERY` modes, expression-style targets including function-call tails, and exact user-variable targets. |
