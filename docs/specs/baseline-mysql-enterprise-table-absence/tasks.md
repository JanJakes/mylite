# Baseline mysql Enterprise table absence tasks

- [x] Record official MySQL 8.4 documentation references for Enterprise Audit
  and Enterprise Firewall mysql system tables.
...
- [x] Add focused C runtime coverage for direct reads, metadata statements,
  selected-schema reads, and directory absence.
