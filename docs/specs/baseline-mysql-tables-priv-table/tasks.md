# Baseline mysql.tables_priv table tasks
...
- [x] Specify the MyLite scope as an empty read-only metadata placeholder
  without table-level grant storage or enforcement.
...
- [x] Implement the `mysql.tables_priv` table definition and index metadata.
