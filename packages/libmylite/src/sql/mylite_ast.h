...
enum mylite_sql_ast_placeholder_statement_kind {
    ...
    MYLITE_SQL_AST_PLACEHOLDER_SHOW_ENGINE_STATUS = 34,
};
...
enum mylite_sql_ast_operator {
    ...
    MYLITE_SQL_AST_OPERATOR_COLLATE = 45,
};
...
enum mylite_sql_ast_key_part_kind {
    MYLITE_SQL_AST_KEY_PART_IDENTIFIER = 0,
    MYLITE_SQL_AST_KEY_PART_FUNCTIONAL = 1,
};
...
enum mylite_sql_ast_alter_table_action {
    ...
    MYLITE_SQL_AST_ALTER_TABLE_ACTION_ALTER_COLUMN_SET_DEFAULT = 21,
    MYLITE_SQL_AST_ALTER_TABLE_ACTION_ALTER_COLUMN_DROP_DEFAULT = 22,
};
...
struct mylite_sql_ast_node {
    ...
    enum mylite_sql_ast_key_part_kind key_part_kind;
