...
- numeric functions: `ABS`, `SIGN`, `FLOOR`, `CEIL`, `CEILING`, `MOD`,
  ...
  `docs/specs/atan-functions/specs.md` and
...
| `ATAN(1)` | `0.7853981633974483` | none |
| `ATAN(1,2)` | `0.4636476090008061` | none |
| `ATAN2(1)` | `0.7853981633974483` | none |
| `ATAN2('1x','2x')` | `0.4636476090008061` | two warning 1292 records, left to right |
| `DEGREES(PI())` | `180` | none |
...
| `HOUR('12:34:56')`, `MINUTE('12:34:56')`, `SECOND('12:34:56')` | `12`, `34`, `56` |
...
| `ADDDATE('2024-01-01', 1)` | `2024-01-02` |
| `SUBDATE('2024-01-01', 1)` | `2023-12-31` |
...
| `LOWER(int_col) AS lower_id` | `VAR_STRING` | source display length times connection max bytes per character | `31` | connection collation | none |
...
| `REPLACE(varchar_col,'a','b') AS replace_same` | `VAR_STRING` | source octet length | `31` | connection collation | none |
| `REPLACE(varchar_col,'a','xyz') AS replace_wide` | `VAR_STRING` | source octet length times the MySQL-observed text replacement multiplier | `31` | connection collation | none |
| `REPLACE(varchar_col,'a',char_col) AS replace_dynamic` | `VAR_STRING` | source octet length times the replacement expression's text multiplier | `31` | connection collation | none |
| `REPLACE(varchar_col,'a',NULL) AS replace_null` | `VAR_STRING` | source octet length | `31` | connection collation | none |
...
| `ATAN(1,2) AS atan_yx` | `DOUBLE` | `23` | `31` | `binary` | `BINARY NUM` |
| `ATAN2(1) AS atan2_one` | `DOUBLE` | `23` | `31` | `binary` | `BINARY NUM` |
...
0.6420926159343306, 0, 0.2013579207903308, 0.7853981633974483,
0.4636476090008061, 180, 3.141592653589793, 1
```
