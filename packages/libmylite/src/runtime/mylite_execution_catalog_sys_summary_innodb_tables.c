...
static const struct mylite_execution_catalog_column_definition sys_innodb_lock_waits_columns[] = {
    ...
    {"waiting_trx_rows_modified",
     ...
     NULL,
     "bigint unsigned"},
    {"waiting_pid", "0", "NO", "bigint", NULL, NULL, "20", "0", NULL, NULL, NULL, "bigint unsigned"
    },
    {"waiting_query",
     NULL,
     "YES",
    ...
    {"blocking_trx_id",
     ...
     NULL,
     "bigint unsigned"},
    {"blocking_pid", "0", "NO", "bigint", NULL, NULL, "20", "0", NULL, NULL, NULL, "bigint unsigned"
    },
    {"blocking_query",
     NULL,
     "YES",
...
static const struct mylite_execution_catalog_mysql_system_table
    sys_summary_innodb_system_table_definitions[] = {
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_buffer_stats_by_schema_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_buffer_stats_by_schema_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_buffer_stats_by_schema_column_privileges),
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_buffer_stats_by_table_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_buffer_stats_by_table_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_buffer_stats_by_table_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_lock_waits_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_lock_waits_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_innodb_lock_waits_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
