...
#define EXPECT_SINGLE_TOKEN(sql_value, modes_value, kind_value, error_value)                       \
    expect_single_token((struct single_token_expectation){                                         \
...
static int expect_sequence(const char *sql, unsigned int modes,
                           const struct expected_token *expected, size_t expected_count);
static int expect_single_token(struct single_token_expectation expected);
static int compare_token(const char *sql, size_t index, const struct mylite_sql_token *actual,
...
static int test_keywords(void)
{
    ...
    failures += expect_keyword("execute", MYLITE_SQL_KEYWORD_RESTRICTED_LABEL |
...
static int test_basic_select_tokens(void)
{
    static const struct expected_token expected[] = {
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_KEYWORD, "SELECT", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, MYLITE_SQL_KEYWORD_RESERVED),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_QUOTED_IDENTIFIER, "`select`", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_IDENTIFIER, "mylite_id", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_KEYWORD, "FROM", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, MYLITE_SQL_KEYWORD_RESERVED),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_IDENTIFIER, "mylite_posts", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_KEYWORD, "WHERE", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, MYLITE_SQL_KEYWORD_RESERVED),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_IDENTIFIER, "mylite_id", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_OPERATOR, "<=>", MYLITE_SQL_OPERATOR_NULL_SAFE_EQUAL,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PARAMETER, "?", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ";", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_EOF, "", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
    };

    return expect_sequence("SELECT `select`, mylite_id FROM mylite_posts WHERE mylite_id <=> ?;",
...
static int test_literals(void)
{
    static const struct expected_token expected[] = {
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_KEYWORD, "SELECT", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, MYLITE_SQL_KEYWORD_RESERVED),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_NATIONAL_STRING, "N'a'", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_HEX_LITERAL, "X'0AFF'", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_HEX_LITERAL, "0xabc", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_BIT_LITERAL, "b''", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_BIT_LITERAL, "0b101", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_FLOAT, "1e+3", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_IDENTIFIER, "1e", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_OPERATOR, "+", MYLITE_SQL_OPERATOR_PLUS,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_INTEGER, "3", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_DECIMAL, ".25", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_DECIMAL, "3.", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_IDENTIFIER, "0XCAFE", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_IDENTIFIER, "0B101", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_IDENTIFIER, "0x1G", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_IDENTIFIER, "0b102", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_EOF, "", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
    };

    return expect_sequence("SELECT N'a', X'0AFF', 0xabc, b'', 0b101, 1e+3, 1e + 3, .25, 3., "
...
static int test_comments(void)
{
    static const struct expected_token expected[] = {
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_KEYWORD, "SELECT", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, MYLITE_SQL_KEYWORD_RESERVED),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_INTEGER, "1", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_OPERATOR, "-", MYLITE_SQL_OPERATOR_MINUS,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_OPERATOR, "-", MYLITE_SQL_OPERATOR_MINUS,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_INTEGER, "2", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ";", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_KEYWORD, "SELECT", MYLITE_SQL_OPERATOR_NONE,
        ...
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_INTEGER, "1", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_COMMENT, "-- comment", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_OPERATOR, "+", MYLITE_SQL_OPERATOR_PLUS,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_INTEGER, "2", MYLITE_SQL_OPERATOR_NONE,
        ...
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_KEYWORD, "SELECT", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, MYLITE_SQL_KEYWORD_RESERVED),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_VERSION_COMMENT, "/*!80409 STRAIGHT_JOIN */",
                       MYLITE_SQL_OPERATOR_NONE, MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_INTEGER, "1", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_HINT_COMMENT, "/*+ HINT */", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ";", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_EOF, "", MYLITE_SQL_OPERATOR_NONE,
    ...
    return expect_sequence(
        "SELECT 1--2; SELECT 1 -- comment\n+2; SELECT /*!80409 STRAIGHT_JOIN */ 1 /*+ HINT */;", 0U,
...
static int test_whitespace(void)
{
    static const struct expected_token expected[] = {
        ...
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_INTEGER, "1", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_COMMENT, "--\vcomment", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_OPERATOR, "+", MYLITE_SQL_OPERATOR_PLUS,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_INTEGER, "2", MYLITE_SQL_OPERATOR_NONE,
    ...
    return expect_sequence("SELECT\v1; SELECT 1--\vcomment\n+2;", 0U, expected,
...
static int test_modes(void)
{
    ...
    failures += EXPECT_SINGLE_TOKEN("\"mylite_name\"", 0U, MYLITE_SQL_TOKEN_STRING,
                                    MYLITE_SQL_LEXER_ERROR_NONE);
    failures +=
        EXPECT_SINGLE_TOKEN("\"mylite_name\"", MYLITE_SQL_MODE_ANSI_QUOTES,
                            MYLITE_SQL_TOKEN_QUOTED_IDENTIFIER, MYLITE_SQL_LEXER_ERROR_NONE);
    failures += EXPECT_SINGLE_TOKEN("'a\\'", 0U, MYLITE_SQL_TOKEN_ERROR,
                                    MYLITE_SQL_LEXER_ERROR_UNTERMINATED_STRING);
    failures += EXPECT_SINGLE_TOKEN("'a\\'", MYLITE_SQL_MODE_NO_BACKSLASH_ESCAPES,
                                    MYLITE_SQL_TOKEN_STRING, MYLITE_SQL_LEXER_ERROR_NONE);
...
static int test_variables(void)
{
    static const struct expected_token expected[] = {
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_KEYWORD, "SELECT", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, MYLITE_SQL_KEYWORD_RESERVED),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_SYSTEM_VARIABLE, "@@session.sql_mode",
                       MYLITE_SQL_OPERATOR_NONE, MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        ...
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_USER_VARIABLE, "@'dash-name'", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_USER_VARIABLE, "@\"double-name\"", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_PUNCTUATION, ",", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_USER_VARIABLE, "@`tick-name`", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
        EXPECTED_TOKEN(MYLITE_SQL_TOKEN_EOF, "", MYLITE_SQL_OPERATOR_NONE,
                       MYLITE_SQL_LEXER_ERROR_NONE, 0U),
    };
...
static int test_errors(void)
{
    ...
    failures += EXPECT_SINGLE_TOKEN("X'FFF'", 0U, MYLITE_SQL_TOKEN_ERROR,
                                    MYLITE_SQL_LEXER_ERROR_INVALID_HEX_LITERAL);
    failures += EXPECT_SINGLE_TOKEN("X'0G'", 0U, MYLITE_SQL_TOKEN_ERROR,
                                    MYLITE_SQL_LEXER_ERROR_INVALID_HEX_LITERAL);
    failures += EXPECT_SINGLE_TOKEN("b'2'", 0U, MYLITE_SQL_TOKEN_ERROR,
    ...
    do {
        ...
        if (token.kind == MYLITE_SQL_TOKEN_ERROR) {
            fprintf(
                ...
                mylite_sql_lexer_error_name(token.error), token.offset, token.line, token.column,
...
static int expect_single_token(struct single_token_expectation expected)
{
    ...
    return expect_sequence(expected.sql, expected.modes, tokens,
                         ...
                         const struct expected_token *expected)
{
    ...
    if (actual->kind != expected->kind) {
        fprintf(stderr, "token %zu in '%s': expected kind %s, got %s near '%.*s'\n", index, sql,
                mylite_sql_token_kind_name(expected->kind),
                mylite_sql_token_kind_name(actual->kind), (int)actual->length,
    ...
    if (actual->length != expected_length ||
        ...
        fprintf(stderr, "token %zu in '%s': expected text '%s', got '%.*s'\n", index, sql,
                expected->text, (int)actual->length, actual->text == NULL ? "" : actual->text);
        return 1;
    }

    if (actual->operator_kind != expected->operator_kind) {
        fprintf(stderr, "token %zu in '%s': expected operator %s, got %s\n", index, sql,
    ...
    if (actual->error != expected->error) {
        fprintf(stderr, "token %zu in '%s': expected error %s, got %s\n", index, sql,
    ...
    if ((actual->keyword_flags & expected->keyword_flags) != expected->keyword_flags) {
        fprintf(stderr, "token %zu in '%s': expected keyword flags 0x%x, got 0x%x\n", index, sql,
                expected->keyword_flags, actual->keyword_flags);
        return 1;
    }
