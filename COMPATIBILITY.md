...
| `EXPLAIN` | ❌ | high | Explain SELECT/TABLE/INSERT/UPDATE/DELETE, formats, ANALYZE, and FOR CONNECTION. | Parser records direct table targets, named connection targets, and explainable query targets; optimizer plans and result rows are not implemented. |
