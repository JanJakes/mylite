# Baseline mysql.func Table Tasks
...
- [x] Add the MySQL-runtime expectation script for the supported func table
      surface.
- [x] Implement MyLite-owned `mysql.func` definition, empty reads, and
