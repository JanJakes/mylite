...
| Performance Schema replication tables | 🟡 | Supported no-replication table set exposes MySQL-shaped metadata and empty read-only rows; no source/channel/filter/applier/failover/group-membership state |
