...
enum {
    ...
    information_schema_columns_row_count = 26,
...
static int test_sys_io_global_by_wait_by_bytes_views(void);
...
static const char
    *const sys_io_global_by_wait_by_bytes_columns[sys_io_global_by_wait_by_bytes_column_count] = {
        "event_name",
        "total",
        "total_latency",
        "min_latency",
...
int main(void) {
    return test_sys_io_global_by_wait_by_bytes_views() == 0 ? 0 : 1;
}

static int test_sys_io_global_by_wait_by_bytes_views(void) {
    static const char *const count_column[] = {"COUNT(*)"};
    static const char *const count_zero[] = {"0"};
    static const char *const count_thirteen[] = {"13"};
    static const char *const count_twenty_six[] = {"26"};
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT * FROM sys.io_global_by_wait_by_bytes",
            .column_names = sys_io_global_by_wait_by_bytes_columns,
            .column_count = sys_io_global_by_wait_by_bytes_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys io global by wait by bytes rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys io global by wait by bytes row_count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.io_global_by_wait_by_bytes",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by bytes count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.`x$io_global_by_wait_by_bytes`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys x io global by wait by bytes count",
        }
    );
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM io_global_by_wait_by_bytes",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by bytes selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM `x$io_global_by_wait_by_bytes`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys x io global by wait by bytes selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM io_global_by_wait_by_bytes",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = formatted_show_columns_values,
            .row_count = sys_io_global_by_wait_by_bytes_column_count,
            .context = "sys io global by wait by bytes show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM `x$io_global_by_wait_by_bytes`",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = raw_show_columns_values,
            .row_count = sys_io_global_by_wait_by_bytes_column_count,
            .context = "sys x io global by wait by bytes show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "DESCRIBE io_global_by_wait_by_bytes",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = formatted_show_columns_values,
            .row_count = sys_io_global_by_wait_by_bytes_column_count,
            .context = "sys io global by wait by bytes describe",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM io_global_by_wait_by_bytes "
                   "WHERE Field IN ('event_name', 'total_latency', 'total_read', "
                   "'avg_written')",
            ...
            .row_count = 4U,
            .context = "sys io global by wait by bytes show full columns sample",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM `x$io_global_by_wait_by_bytes` "
                   "WHERE Field IN ('event_name', 'total_latency', 'total_read', "
                   "'avg_written')",
            .column_names = show_full_columns_columns,
            .column_count = show_full_columns_column_count,
            ...
            .row_count = 4U,
            .context = "sys x io global by wait by bytes show full columns sample",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM io_global_by_wait_by_bytes",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys io global by wait by bytes show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM `x$io_global_by_wait_by_bytes`",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys x io global by wait by bytes show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_NAME, COLUMN_NAME, ORDINAL_POSITION, IS_NULLABLE, "
                   ...
                   "AND ((TABLE_NAME = 'io_global_by_wait_by_bytes') OR "
                   "(TABLE_NAME = 'x$io_global_by_wait_by_bytes'))",
            ...
            .context = "sys io global by wait by bytes information_schema.columns rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .column_names = count_column,
            .column_count = 1U,
            .values = count_thirteen,
            .row_count = 1U,
            .context = "sys io global by wait by bytes information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_thirteen,
            .row_count = 1U,
            .context = "sys x io global by wait by bytes information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS "
                   ...
                   "((TABLE_NAME = 'io_global_by_wait_by_bytes') OR "
                   "(TABLE_NAME = 'x$io_global_by_wait_by_bytes'))",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_twenty_six,
            .row_count = 1U,
            .context = "sys io global by wait by bytes information_schema.columns combined count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 2U,
            .context = "sys io global by wait by bytes information_schema.tables rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'io_global_by_wait_by_bytes'",
            ...
            .row_count = 1U,
            .context = "sys io global by wait by bytes show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'x$io_global_by_wait_by_bytes'",
            .column_names = show_table_status_columns,
            .column_count = show_table_status_column_count,
            .values = raw_show_table_status_values,
            .row_count = 1U,
            .context = "sys x io global by wait by bytes show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_SCHEMA, TABLE_NAME, CHECK_OPTION, IS_UPDATABLE, DEFINER, "
                   ...
                   "AND ((TABLE_NAME = 'io_global_by_wait_by_bytes') OR "
                   "(TABLE_NAME = 'x$io_global_by_wait_by_bytes')) ORDER BY TABLE_NAME",
            ...
            .row_count = 2U,
            .context = "sys io global by wait by bytes information_schema.views rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT VIEW_SCHEMA, VIEW_NAME, TABLE_SCHEMA, TABLE_NAME "
                   ...
                   "AND ((VIEW_NAME = 'io_global_by_wait_by_bytes') OR "
                   "(VIEW_NAME = 'x$io_global_by_wait_by_bytes'))",
            ...
            .row_count = 2U,
            .context = "sys io global by wait by bytes view_table_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = NULL,
            .row_count = 0U,
            .context = "sys io global by wait by bytes empty view_routine_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by bytes empty statistics",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by bytes empty constraints",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by bytes empty key column usage",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by bytes empty constraint extensions",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW io_global_by_wait_by_bytes",
            ...
            .needle = "CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `io_global_by_wait_by_bytes`",
            .context = "sys io global by wait by bytes show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW `x$io_global_by_wait_by_bytes`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `x$io_global_by_wait_by_bytes`",
            .context = "sys x io global by wait by bytes show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE sys.io_global_by_wait_by_bytes",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `sys`.`io_global_by_wait_by_bytes`",
            .context = "sys io global by wait by bytes qualified show create table",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE `x$io_global_by_wait_by_bytes`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "from `performance_schema`.`file_summary_by_event_name` where",
            .context = "sys x io global by wait by bytes show create source",
        }
    );
...
static int make_test_path(char *path, size_t path_size, const char *name) {
    int written = snprintf(
        path,
        path_size,
        "/tmp/mylite_runtime_sys_io_global_by_wait_by_bytes_views_%d_%s.mylite",
        current_process_id(),
        name
    );
