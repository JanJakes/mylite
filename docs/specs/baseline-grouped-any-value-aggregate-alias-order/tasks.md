# Baseline Grouped ANY_VALUE Aggregate Alias Order Tasks
...
- [x] Add MySQL 8.4.9 expectation coverage for selected alias ordering.
- [x] Add runtime C coverage for selected alias ordering.
- [x] Confirm no parser, catalog, file-format, VFS, or public ABI changes are needed.
