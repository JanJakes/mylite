# Baseline mysql.default_roles table tasks
...
- [x] Specify the MyLite scope as an empty read-only metadata placeholder
  without default-role storage or enforcement.
...
- [x] Implement the `mysql.default_roles` table definition and index metadata.
