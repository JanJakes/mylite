# Baseline mysql.ndb_binlog_index Tasks
...
- [x] Specify the MyLite scope as read-only empty NDB binlog-index metadata
  without NDB Cluster replication behavior.
...
- [x] Implement the supported `mysql` system-table definition.
