...
static int test_values_show_and_scope(void) {
    ...
    failures += expect_int(mylite_open_memory(&database), MYLITE_OK, "open O optimizer db");
...
static int test_set_session_values_and_interactions(void) {
    ...
    failures += expect_int(mylite_open_memory(&database), MYLITE_OK, "open O SET db");
...
static int test_diagnostics(void) {
    ...
    failures += expect_int(mylite_open_memory(&database), MYLITE_OK, "open O diagnostics db");
