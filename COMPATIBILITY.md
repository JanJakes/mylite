...
| `TABLE` | ❌ | medium | Table-value statement syntax and ordering/limit behavior. | Parser records direct and parenthesized `TABLE` query-expression table targets; result rows, ordering, limit, and export/variable targets are not implemented. |
