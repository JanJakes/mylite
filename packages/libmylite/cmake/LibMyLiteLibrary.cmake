...
add_library(mylite
  ...
  src/runtime/mylite_catalog_integrity_seal.c
  ...
  src/runtime/mylite_execution_ddl_sql_lowering.c
  src/runtime/mylite_execution_information_schema_join_plan.c
  ...
  src/runtime/mylite_execution_session_programs.c
  src/runtime/mylite_execution_set.c
...
set(MYLITE_PKGCONFIG_PRIVATE_REQUIRES "")
if(NOT BUILD_SHARED_LIBS)
  set(MYLITE_PKGCONFIG_PRIVATE_LIBS "-lmylite_sqlite")
  set(MYLITE_PKGCONFIG_PRIVATE_REQUIRES "zlib")
  if(UNIX AND NOT APPLE)
    string(APPEND MYLITE_PKGCONFIG_PRIVATE_LIBS " -lm")
  endif()
  if(WIN32)
    string(APPEND MYLITE_PKGCONFIG_PRIVATE_LIBS " -lbcrypt")
  endif()
