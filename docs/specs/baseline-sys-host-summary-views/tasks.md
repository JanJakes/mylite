# Baseline sys.host_summary views tasks

- [x] Record official MySQL 8.4 documentation references for the sys host
      summary view surface, Performance Schema account source, and SHOW CREATE
      metadata.
...
- [x] Specify empty placeholder behavior and intentionally unsupported live
      host/account, statement, file-I/O, memory, and raw-warning behavior.
