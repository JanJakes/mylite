# Baseline Server Environment System Variables Tasks
...
- [x] Add read-only SET handling for the supported variables.
- [x] Add C runtime coverage for scalar reads, SHOW rows, diagnostics, file
  safety, reopen behavior, and independent handles.
