...
| `STOP REPLICA` | ❌ | low | Replica stop syntax and channel handling. | Parser recognizes `IO_THREAD`/`RELAY_THREAD` and `SQL_THREAD` plus channel clauses with channel names using the shared identifier grammar. |
