...
int mylite_show_status_sql(
    ...
    *out_sql = NULL;
    ...
    append_show_status_row(sql, &first, "Aborted_clients", "0");
    append_show_status_row(sql, &first, "Aborted_connects", "0");
    append_show_status_row(sql, &first, "Bytes_received", "0");
    append_show_status_row(sql, &first, "Bytes_sent", "0");
    append_show_status_row(sql, &first, "Com_alter_table", "0");
    ...
    append_show_status_row(sql, &first, "Com_stmt_close", "0");
    append_show_status_row(sql, &first, "Com_stmt_execute", "0");
    append_show_status_row(sql, &first, "Com_stmt_fetch", "0");
    append_show_status_row(sql, &first, "Com_stmt_prepare", "0");
    append_show_status_row(sql, &first, "Com_stmt_reprepare", "0");
    append_show_status_row(sql, &first, "Com_stmt_reset", "0");
    append_show_status_row(sql, &first, "Com_stmt_send_long_data", "0");
    ...
    append_show_status_row(sql, &first, "Handler_commit", "0");
    append_show_status_row(sql, &first, "Handler_delete", "0");
    append_show_status_row(sql, &first, "Handler_external_lock", "0");
    append_show_status_row(sql, &first, "Handler_mrr_init", "0");
    append_show_status_row(sql, &first, "Handler_prepare", "0");
    append_show_status_row(sql, &first, "Handler_read_first", "0");
    append_show_status_row(sql, &first, "Handler_read_key", "0");
    append_show_status_row(sql, &first, "Handler_read_last", "0");
    append_show_status_row(sql, &first, "Handler_read_next", "0");
    append_show_status_row(sql, &first, "Handler_read_prev", "0");
    append_show_status_row(sql, &first, "Handler_read_rnd", "0");
    append_show_status_row(sql, &first, "Handler_read_rnd_next", "0");
    append_show_status_row(sql, &first, "Handler_rollback", "0");
    append_show_status_row(sql, &first, "Handler_savepoint", "0");
    append_show_status_row(sql, &first, "Handler_savepoint_rollback", "0");
    append_show_status_row(sql, &first, "Handler_update", "0");
    append_show_status_row(sql, &first, "Handler_write", "0");
    append_show_status_row(sql, &first, "Last_query_cost", "0.000000");
    append_show_status_row(sql, &first, "Open_tables", "0");
    append_show_status_row(sql, &first, "Opened_tables", "0");
    append_show_status_row(sql, &first, "Queries", "0");
    append_show_status_row(sql, &first, "Questions", "0");
    append_show_status_row(sql, &first, "Select_full_join", "0");
    append_show_status_row(sql, &first, "Select_full_range_join", "0");
    append_show_status_row(sql, &first, "Select_range", "0");
    append_show_status_row(sql, &first, "Select_range_check", "0");
    append_show_status_row(sql, &first, "Select_scan", "0");
    append_show_status_row(sql, &first, "Slow_queries", "0");
    append_show_status_row(sql, &first, "Sort_merge_passes", "0");
    append_show_status_row(sql, &first, "Sort_range", "0");
    append_show_status_row(sql, &first, "Sort_rows", "0");
    append_show_status_row(sql, &first, "Sort_scan", "0");
    append_show_status_row(sql, &first, "Table_locks_immediate", "0");
    append_show_status_row(sql, &first, "Table_locks_waited", "0");
