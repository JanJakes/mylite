...
enum {
    ...
    information_schema_columns_row_count = 28,
...
static int test_sys_io_global_by_wait_by_latency_views(void);
...
static const char *const
    sys_io_global_by_wait_by_latency_columns[sys_io_global_by_wait_by_latency_column_count] = {
        "event_name",
        "total",
        "total_latency",
        "avg_latency",
...
int main(void) {
    return test_sys_io_global_by_wait_by_latency_views() == 0 ? 0 : 1;
}
...
static int test_sys_io_global_by_wait_by_latency_views(void) {
    ...
    static const char *const count_twenty_eight[] = {"28"};
    ...
    failures += expect_query(
        ...
        (struct expected_query){
            ...
            .column_names = sys_io_global_by_wait_by_latency_columns,
            .column_count = sys_io_global_by_wait_by_latency_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys io global by wait by latency rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys io global by wait by latency row_count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.io_global_by_wait_by_latency",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by latency count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.`x$io_global_by_wait_by_latency`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys x io global by wait by latency count",
        }
    );
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM io_global_by_wait_by_latency",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by latency selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM `x$io_global_by_wait_by_latency`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys x io global by wait by latency selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM io_global_by_wait_by_latency",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = formatted_show_columns_values,
            .row_count = sys_io_global_by_wait_by_latency_column_count,
            .context = "sys io global by wait by latency show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM `x$io_global_by_wait_by_latency`",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = raw_show_columns_values,
            .row_count = sys_io_global_by_wait_by_latency_column_count,
            .context = "sys x io global by wait by latency show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "DESCRIBE io_global_by_wait_by_latency",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = formatted_show_columns_values,
            .row_count = sys_io_global_by_wait_by_latency_column_count,
            .context = "sys io global by wait by latency describe",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM io_global_by_wait_by_latency "
                   "WHERE Field IN ('event_name', 'total_latency', 'read_latency', "
                   "'avg_written')",
            ...
            .row_count = 4U,
            .context = "sys io global by wait by latency show full columns sample",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM `x$io_global_by_wait_by_latency` "
                   "WHERE Field IN ('event_name', 'total_latency', 'read_latency', "
                   "'avg_written')",
            .column_names = show_full_columns_columns,
            .column_count = show_full_columns_column_count,
            ...
            .row_count = 4U,
            .context = "sys x io global by wait by latency show full columns sample",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM io_global_by_wait_by_latency",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys io global by wait by latency show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM `x$io_global_by_wait_by_latency`",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys x io global by wait by latency show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_NAME, COLUMN_NAME, ORDINAL_POSITION, IS_NULLABLE, "
                   ...
                   "AND ((TABLE_NAME = 'io_global_by_wait_by_latency') OR "
                   "(TABLE_NAME = 'x$io_global_by_wait_by_latency'))",
            ...
            .context = "sys io global by wait by latency information_schema.columns rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys io global by wait by latency information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_fourteen,
            .row_count = 1U,
            .context = "sys x io global by wait by latency information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS "
                   ...
                   "((TABLE_NAME = 'io_global_by_wait_by_latency') OR "
                   "(TABLE_NAME = 'x$io_global_by_wait_by_latency'))",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_twenty_eight,
            .row_count = 1U,
            .context = "sys io global by wait by latency information_schema.columns combined count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 2U,
            .context = "sys io global by wait by latency information_schema.tables rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'io_global_by_wait_by_latency'",
            ...
            .row_count = 1U,
            .context = "sys io global by wait by latency show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'x$io_global_by_wait_by_latency'",
            .column_names = show_table_status_columns,
            .column_count = show_table_status_column_count,
            .values = raw_show_table_status_values,
            .row_count = 1U,
            .context = "sys x io global by wait by latency show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_SCHEMA, TABLE_NAME, CHECK_OPTION, IS_UPDATABLE, DEFINER, "
                   ...
                   "AND ((TABLE_NAME = 'io_global_by_wait_by_latency') OR "
                   "(TABLE_NAME = 'x$io_global_by_wait_by_latency')) ORDER BY TABLE_NAME",
            ...
            .row_count = 2U,
            .context = "sys io global by wait by latency information_schema.views rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT VIEW_SCHEMA, VIEW_NAME, TABLE_SCHEMA, TABLE_NAME "
                   ...
                   "AND ((VIEW_NAME = 'io_global_by_wait_by_latency') OR "
                   "(VIEW_NAME = 'x$io_global_by_wait_by_latency'))",
            ...
            .row_count = 2U,
            .context = "sys io global by wait by latency view_table_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = NULL,
            .row_count = 0U,
            .context = "sys io global by wait by latency empty view_routine_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by latency empty statistics",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by latency empty constraints",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by latency empty key column usage",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys io global by wait by latency empty constraint extensions",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW io_global_by_wait_by_latency",
            ...
            .needle = "CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `io_global_by_wait_by_latency`",
            .context = "sys io global by wait by latency show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW `x$io_global_by_wait_by_latency`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `x$io_global_by_wait_by_latency`",
            .context = "sys x io global by wait by latency show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE sys.io_global_by_wait_by_latency",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `sys`.`io_global_by_wait_by_latency`",
            .context = "sys io global by wait by latency qualified show create table",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE `x$io_global_by_wait_by_latency`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            ...
            .context = "sys x io global by wait by latency show create source",
        }
    );
...
static int make_test_path(char *path, size_t path_size, const char *name) {
    int written = snprintf(
        path,
        path_size,
        "/tmp/mylite_runtime_sys_io_global_by_wait_by_latency_views_%d_%s.mylite",
        current_process_id(),
        name
    );
