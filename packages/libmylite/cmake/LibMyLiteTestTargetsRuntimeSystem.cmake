  ...
  add_executable(mylite_runtime_statement_digest_function_test
    tests/runtime_statement_digest_function_test.c
  )
  target_link_libraries(mylite_runtime_statement_digest_function_test PRIVATE
    MyLite::mylite
  )
  target_include_directories(mylite_runtime_statement_digest_function_test PRIVATE
    "${CMAKE_CURRENT_SOURCE_DIR}/src"
  )
  mylite_configure_c_target(mylite_runtime_statement_digest_function_test)
  ...
  add_executable(mylite_runtime_json_schema_functions_test
    tests/runtime_json_schema_functions_test.c
  )
  target_link_libraries(mylite_runtime_json_schema_functions_test PRIVATE
    MyLite::mylite
  )
  target_include_directories(mylite_runtime_json_schema_functions_test PRIVATE
    "${CMAKE_CURRENT_SOURCE_DIR}/src"
  )
  mylite_configure_c_target(mylite_runtime_json_schema_functions_test)
  ...
  add_executable(mylite_runtime_json_aggregate_functions_test
    tests/runtime_json_aggregate_functions_test.c
  )
  target_link_libraries(mylite_runtime_json_aggregate_functions_test PRIVATE
    MyLite::mylite
  )
  target_include_directories(mylite_runtime_json_aggregate_functions_test PRIVATE
    "${CMAKE_CURRENT_SOURCE_DIR}/src"
  )
  mylite_configure_c_target(mylite_runtime_json_aggregate_functions_test)

  add_executable(mylite_runtime_json_aggregate_window_functions_test
    tests/runtime_json_aggregate_window_functions_test.c
  )
  target_link_libraries(mylite_runtime_json_aggregate_window_functions_test PRIVATE
    MyLite::mylite
  )
  target_include_directories(mylite_runtime_json_aggregate_window_functions_test PRIVATE
    "${CMAKE_CURRENT_SOURCE_DIR}/src"
  )
  ...
  add_executable(mylite_runtime_spatial_constructive_operator_functions_test
    tests/runtime_spatial_constructive_operator_functions_test.c
  )
  target_link_libraries(mylite_runtime_spatial_constructive_operator_functions_test PRIVATE
    MyLite::mylite
  )
  target_include_directories(mylite_runtime_spatial_constructive_operator_functions_test PRIVATE
    "${CMAKE_CURRENT_SOURCE_DIR}/src"
  )
  mylite_configure_c_target(mylite_runtime_spatial_constructive_operator_functions_test)
