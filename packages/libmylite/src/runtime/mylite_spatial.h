...
enum mylite_spatial_function_kind {
    ...
    MYLITE_SPATIAL_FUNCTION_ST_ASGEOJSON = 79,
    MYLITE_SPATIAL_FUNCTION_ST_GEOMFROMGEOJSON = 80,
    MYLITE_SPATIAL_FUNCTION_ST_LATITUDE = 81,
    MYLITE_SPATIAL_FUNCTION_ST_LONGITUDE = 82,
    MYLITE_SPATIAL_FUNCTION_ST_DISTANCE = 83,
    MYLITE_SPATIAL_FUNCTION_ST_LINEINTERPOLATEPOINT = 84,
    MYLITE_SPATIAL_FUNCTION_ST_LINEINTERPOLATEPOINTS = 85,
    MYLITE_SPATIAL_FUNCTION_ST_POINTATDISTANCE = 86,
    MYLITE_SPATIAL_FUNCTION_ST_DISTANCESPHERE = 87,
    MYLITE_SPATIAL_FUNCTION_ST_CENTROID = 88,
    MYLITE_SPATIAL_FUNCTION_ST_FRECHETDISTANCE = 89,
    MYLITE_SPATIAL_FUNCTION_ST_HAUSDORFFDISTANCE = 90,
    ...
    MYLITE_SPATIAL_FUNCTION_ST_DISJOINT = 95,
    MYLITE_SPATIAL_FUNCTION_ST_INTERSECTS = 96,
    MYLITE_SPATIAL_FUNCTION_ST_CONTAINS = 97,
    ...
    MYLITE_SPATIAL_FUNCTION_ST_CROSSES = 102,
    MYLITE_SPATIAL_FUNCTION_ST_SIMPLIFY = 103,
    MYLITE_SPATIAL_FUNCTION_ST_BUFFER = 104,
    MYLITE_SPATIAL_FUNCTION_ST_BUFFER_STRATEGY = 105,
    MYLITE_SPATIAL_FUNCTION_ST_DIFFERENCE = 106,
    MYLITE_SPATIAL_FUNCTION_ST_INTERSECTION = 107,
    MYLITE_SPATIAL_FUNCTION_ST_SYMDIFFERENCE = 108,
    MYLITE_SPATIAL_FUNCTION_ST_TRANSFORM = 109,
    MYLITE_SPATIAL_FUNCTION_ST_UNION = 110,
};
