...
enum session_system_variable_kind {
    ...
    SESSION_SYSTEM_VARIABLE_SQL_SAFE_UPDATES = 22,
    SESSION_SYSTEM_VARIABLE_SQL_WARNINGS = 23,
    SESSION_SYSTEM_VARIABLE_SQL_SELECT_LIMIT = 24,
    SESSION_SYSTEM_VARIABLE_SQL_NOTES = 25,
    SESSION_SYSTEM_VARIABLE_SQL_BUFFER_RESULT = 26,
};
