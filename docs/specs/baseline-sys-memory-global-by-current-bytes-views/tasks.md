# Baseline sys.memory_global_by_current_bytes views tasks

- [x] Record official MySQL 8.4 documentation references for the sys global
      memory view surface, Performance Schema source, and SHOW CREATE metadata.
