...
void mylite_mysqli_register_constants(int module_number) {
    ...
    REGISTER_LONG_CONSTANT(
        ...
        MYLITE_MYSQLI_CLIENT_FOUND_ROWS,
        CONST_PERSISTENT
    );
    ...
    REGISTER_LONG_CONSTANT(
        ...
        MYLITE_MYSQLI_STORE_RESULT_COPY_DATA,
        CONST_PERSISTENT
    );
    ...
    REGISTER_LONG_CONSTANT(
        ...
        MYLITE_MYSQLI_TRANS_START_WITH_CONSISTENT_SNAPSHOT,
        CONST_PERSISTENT
    );
    REGISTER_LONG_CONSTANT(
    ...
    REGISTER_LONG_CONSTANT(
        ...
        MYLITE_MYSQLI_TRANS_COR_AND_CHAIN,
        CONST_PERSISTENT
    );
    REGISTER_LONG_CONSTANT(
        "MYSQLI_TRANS_COR_AND_NO_CHAIN",
        MYLITE_MYSQLI_TRANS_COR_AND_NO_CHAIN,
        CONST_PERSISTENT
    );
    REGISTER_LONG_CONSTANT(
        "MYSQLI_TRANS_COR_RELEASE",
        MYLITE_MYSQLI_TRANS_COR_RELEASE,
        CONST_PERSISTENT
    );
    REGISTER_LONG_CONSTANT(
        "MYSQLI_TRANS_COR_NO_RELEASE",
        MYLITE_MYSQLI_TRANS_COR_NO_RELEASE,
        CONST_PERSISTENT
    );
