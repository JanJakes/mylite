...
static int
prepare_schema_lifecycle_statement(mylite_db *database, const struct mylite_sql_ast_node *statement,
                                   mylite_stmt **out_stmt,
                                   const struct mylite_statement_prepare_callbacks *callbacks);
static int
prepare_transaction_statement(mylite_db *database, const struct mylite_sql_ast_node *statement,
                              mylite_stmt **out_stmt,
                              const struct mylite_statement_prepare_callbacks *callbacks);
                                    ...
                                    const struct mylite_statement_prepare_callbacks *callbacks)
{
    ...
    if (statement != NULL) {
        ...
        case MYLITE_SQL_AST_USE_STATEMENT:
            return prepare_schema_lifecycle_statement(database, statement, out_stmt, callbacks);
        ...
        case MYLITE_SQL_AST_TRUNCATE_TABLE_STATEMENT:
            return prepare_custom_statement(database, MYLITE_STMT_TRUNCATE_TABLE, statement,
                                            out_stmt, callbacks);
        ...
        case MYLITE_SQL_AST_INSERT_VALUES_STATEMENT:
            return prepare_custom_statement(database, MYLITE_STMT_INSERT_VALUES, statement,
                                            out_stmt, callbacks);
        ...
        case MYLITE_SQL_AST_REPLACE_VALUES_STATEMENT:
            return prepare_custom_statement(database, MYLITE_STMT_REPLACE_VALUES, statement,
                                            out_stmt, callbacks);
        ...
        case MYLITE_SQL_AST_RELEASE_SAVEPOINT_STATEMENT:
            return prepare_transaction_statement(database, statement, out_stmt, callbacks);
                                   ...
                                   const struct mylite_statement_prepare_callbacks *callbacks)
{
    ...
    return prepare_custom_statement(database, kind, statement, out_stmt, callbacks);
}
