...
| `KILL` | ❌ | medium | Connection/query kill syntax and diagnostics. | Parser records numeric and user-variable processlist id targets and distinguishes `KILL QUERY` from connection termination; termination behavior and privilege diagnostics are not implemented. |
