...
5. Write `specs.md` in the feature directory. It must be MyLite's
   ...
   needs, runtime behavior, storage impact, performance concerns, and known
   incompatibilities. Do not copy documentation, grammar text, or
...
7. Prepare tests before implementation. Expected results must be verified
   ...
   exists and covers the full feature scope.
