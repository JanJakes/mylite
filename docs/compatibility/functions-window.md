...
| `FIRST_VALUE()` | ✅ | Projection-only baseline window support over scalar literals or descriptor columns, including supported `ROWS` / `RANGE` frame clauses. See [rank/navigation](../specs/baseline-window-rank-navigation-functions/specs.md) and [value frame clauses](../specs/baseline-window-value-frame-clauses/specs.md). |
| `LAG()` | 🟡 | Projection-only baseline support over scalar literals or descriptor columns, including accepted/ignored baseline frame clauses; offsets/defaults are literal-only and broader contexts remain deferred. See [rank/navigation](../specs/baseline-window-rank-navigation-functions/specs.md) and [value frame clauses](../specs/baseline-window-value-frame-clauses/specs.md). |
| `LAST_VALUE()` | ✅ | Projection-only baseline window support over scalar literals or descriptor columns, including supported `ROWS` / `RANGE` frame clauses. See [rank/navigation](../specs/baseline-window-rank-navigation-functions/specs.md) and [value frame clauses](../specs/baseline-window-value-frame-clauses/specs.md). |
| `LEAD()` | 🟡 | Projection-only baseline support over scalar literals or descriptor columns, including accepted/ignored baseline frame clauses; offsets/defaults are literal-only and broader contexts remain deferred. See [rank/navigation](../specs/baseline-window-rank-navigation-functions/specs.md) and [value frame clauses](../specs/baseline-window-value-frame-clauses/specs.md). |
| `NTH_VALUE()` | ✅ | Projection-only baseline window support over scalar literals or descriptor columns, including literal indexes and supported `ROWS` / `RANGE` frame clauses. See [rank/navigation](../specs/baseline-window-rank-navigation-functions/specs.md) and [value frame clauses](../specs/baseline-window-value-frame-clauses/specs.md). |
