...
enum {
    ...
    innodb_buffer_stats_by_table_view_table_usage_row_count = 2,
...
static int test_sys_innodb_buffer_stats_by_table_views(void);
...
static const char *const
    sys_innodb_buffer_stats_by_table_columns[sys_innodb_buffer_stats_by_table_column_count] = {
        "object_schema",
        "object_name",
        "allocated",
        "data",
...
int main(void) {
    return test_sys_innodb_buffer_stats_by_table_views() == 0 ? 0 : 1;
}
...
static int test_sys_innodb_buffer_stats_by_table_views(void) {
    ...
    failures += expect_query(
        ...
        (struct expected_query){
            ...
            .column_names = sys_innodb_buffer_stats_by_table_columns,
            .column_count = sys_innodb_buffer_stats_by_table_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys innodb buffer stats by table rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT * FROM sys.`x$innodb_buffer_stats_by_table`",
            .column_names = sys_innodb_buffer_stats_by_table_columns,
            .column_count = sys_innodb_buffer_stats_by_table_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys x innodb buffer stats by table rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys innodb buffer stats by table row_count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.innodb_buffer_stats_by_table",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys innodb buffer stats by table count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.`x$innodb_buffer_stats_by_table`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys x innodb buffer stats by table count",
        }
    );
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM innodb_buffer_stats_by_table",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys innodb buffer stats by table selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM `x$innodb_buffer_stats_by_table`",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys x innodb buffer stats by table selected count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM innodb_buffer_stats_by_table",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = formatted_show_columns_values,
            .row_count = sys_innodb_buffer_stats_by_table_column_count,
            .context = "sys innodb buffer stats by table show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM `x$innodb_buffer_stats_by_table`",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = raw_show_columns_values,
            .row_count = sys_innodb_buffer_stats_by_table_column_count,
            .context = "sys x innodb buffer stats by table show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "DESCRIBE innodb_buffer_stats_by_table",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = formatted_show_columns_values,
            .row_count = sys_innodb_buffer_stats_by_table_column_count,
            .context = "sys innodb buffer stats by table describe",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM innodb_buffer_stats_by_table",
            ...
            .row_count = sys_innodb_buffer_stats_by_table_column_count,
            .context = "sys innodb buffer stats by table show full columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM `x$innodb_buffer_stats_by_table`",
            .column_names = show_full_columns_columns,
            .column_count = show_full_columns_column_count,
            .values = raw_show_full_columns_values,
            .row_count = sys_innodb_buffer_stats_by_table_column_count,
            .context = "sys x innodb buffer stats by table show full columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM innodb_buffer_stats_by_table",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys innodb buffer stats by table show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM `x$innodb_buffer_stats_by_table`",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys x innodb buffer stats by table show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_NAME, COLUMN_NAME, ORDINAL_POSITION, IS_NULLABLE, "
                   ...
                   "AND ((TABLE_NAME = 'innodb_buffer_stats_by_table') OR "
                   "(TABLE_NAME = 'x$innodb_buffer_stats_by_table'))",
            ...
            .context = "sys innodb buffer stats by table information_schema.columns rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS "
                   "WHERE TABLE_SCHEMA = 'sys' AND TABLE_NAME = 'innodb_buffer_stats_by_table'",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_eight,
            .row_count = 1U,
            .context = "sys innodb buffer stats by table information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS "
                   "WHERE TABLE_SCHEMA = 'sys' AND TABLE_NAME = 'x$innodb_buffer_stats_by_table'",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_eight,
            .row_count = 1U,
            .context = "sys x innodb buffer stats by table information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS "
                   ...
                   "'innodb_buffer_stats_by_table') OR (TABLE_NAME = "
                   "'x$innodb_buffer_stats_by_table'))",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_sixteen,
            .row_count = 1U,
            .context = "sys innodb buffer stats by table information_schema.columns combined count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_SCHEMA, TABLE_NAME, TABLE_TYPE, ENGINE, TABLE_ROWS, "
                   ...
                   "WHERE TABLE_SCHEMA = 'sys' AND ((TABLE_NAME = "
                   "'innodb_buffer_stats_by_table') "
                   "OR (TABLE_NAME = 'x$innodb_buffer_stats_by_table')) ORDER BY TABLE_NAME",
            ...
            .row_count = 2U,
            .context = "sys innodb buffer stats by table information_schema.tables rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'innodb_buffer_stats_by_table'",
            ...
            .row_count = 1U,
            .context = "sys innodb buffer stats by table show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'x$innodb_buffer_stats_by_table'",
            .column_names = show_table_status_columns,
            .column_count = show_table_status_column_count,
            .values = raw_show_table_status_values,
            .row_count = 1U,
            .context = "sys x innodb buffer stats by table show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT TABLE_SCHEMA, TABLE_NAME, CHECK_OPTION, IS_UPDATABLE, DEFINER, "
                   ...
                   "AND ((TABLE_NAME = 'innodb_buffer_stats_by_table') OR "
                   "(TABLE_NAME = 'x$innodb_buffer_stats_by_table')) ORDER BY TABLE_NAME",
            ...
            .row_count = 2U,
            .context = "sys innodb buffer stats by table information_schema.views rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT VIEW_SCHEMA, VIEW_NAME, TABLE_SCHEMA, TABLE_NAME "
                   ...
                   "AND ((VIEW_NAME = 'innodb_buffer_stats_by_table') OR "
                   "(VIEW_NAME = 'x$innodb_buffer_stats_by_table'))",
            ...
            .row_count = innodb_buffer_stats_by_table_view_table_usage_row_count,
            .context = "sys innodb buffer stats by table view_table_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = NULL,
            .row_count = 0U,
            .context = "sys innodb buffer stats by table empty view_routine_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS "
                   "WHERE TABLE_SCHEMA = 'sys' AND ((TABLE_NAME = "
                   "'innodb_buffer_stats_by_table') "
                   "OR (TABLE_NAME = 'x$innodb_buffer_stats_by_table'))",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_zero,
            .row_count = 1U,
            .context = "sys innodb buffer stats by table empty statistics",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys innodb buffer stats by table empty constraints",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys innodb buffer stats by table empty key column usage",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys innodb buffer stats by table empty constraint extensions",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW innodb_buffer_stats_by_table",
            ...
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL "
                      "SECURITY INVOKER VIEW `innodb_buffer_stats_by_table`",
            .context = "sys innodb buffer stats by table show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW `x$innodb_buffer_stats_by_table`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL "
                      "SECURITY INVOKER VIEW `x$innodb_buffer_stats_by_table`",
            .context = "sys x innodb buffer stats by table show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE sys.innodb_buffer_stats_by_table",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL "
                      "SECURITY INVOKER VIEW `sys`.`innodb_buffer_stats_by_table`",
            .context = "sys innodb buffer stats by table qualified show create table",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE `x$innodb_buffer_stats_by_table`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            ...
            .context = "sys x innodb buffer stats by table show create source",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW sys.innodb_buffer_stats_by_table",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "group by `object_schema`,`object_name` order by "
                      "sum(if((`ibp`.`COMPRESSED_SIZE` = 0),16384,"
                      "`ibp`.`COMPRESSED_SIZE`)) desc",
            .context = "sys innodb buffer stats by table show create grouping",
        }
    );
...
static int make_test_path(char *path, size_t path_size, const char *name) {
    int written = snprintf(
        path,
        path_size,
        "/tmp/mylite_runtime_sys_innodb_buffer_stats_by_table_views_%d_%s.mylite",
        current_process_id(),
        name
    );
