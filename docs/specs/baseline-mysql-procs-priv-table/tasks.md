# Baseline mysql.procs_priv table tasks
...
- [x] Specify the MyLite scope as an empty read-only metadata placeholder
  without routine-level grant storage or enforcement.
...
- [x] Implement the `mysql.procs_priv` table definition and index metadata.
