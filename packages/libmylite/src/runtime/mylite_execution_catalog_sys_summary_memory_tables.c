...
static const struct mylite_execution_catalog_column_definition
    sys_memory_global_by_current_bytes_columns[] = {
        {"event_name",
         NULL,
         "NO",
         "varchar",
         ...
         "utf8mb4_0900_ai_ci",
         "varchar(128)"},
        {"current_count", NULL, "NO", "bigint", NULL, NULL, "19", "0", NULL, NULL, NULL, "bigint"},
        {"current_alloc",
         NULL,
         "YES",
         "varchar",
        ...
        {"current_avg_alloc",
         ...
         "utf8mb3_general_ci",
         "varchar(11)"},
        {"high_count", NULL, "NO", "bigint", NULL, NULL, "19", "0", NULL, NULL, NULL, "bigint"},
        {"high_alloc",
         NULL,
         "YES",
         "varchar",
...
static const struct mylite_execution_catalog_column_definition
    sys_x_memory_global_by_current_bytes_columns[] = {
        {"event_name",
         NULL,
         "NO",
         "varchar",
         ...
         "varchar(128)"},
        {"current_count", NULL, "NO", "bigint", NULL, NULL, "19", "0", NULL, NULL, NULL, "bigint"},
        {"current_alloc", NULL, "NO", "bigint", NULL, NULL, "19", "0", NULL, NULL, NULL, "bigint"},
        {"current_avg_alloc",
         "0.0000",
         "NO",
         "decimal",
         ...
         "decimal(23,4)"},
        {"high_count", NULL, "NO", "bigint", NULL, NULL, "19", "0", NULL, NULL, NULL, "bigint"},
        {"high_alloc", NULL, "NO", "bigint", NULL, NULL, "19", "0", NULL, NULL, NULL, "bigint"},
        {"high_avg_alloc",
         "0.0000",
         "NO",
         "decimal",
...
static const char *const sys_memory_global_by_current_bytes_column_keys[] = {
    "",
    "",
    "",
    "",
...
static const char *const sys_memory_global_by_current_bytes_column_extras[] = {
    "",
    "",
    "",
    "",
...
static const char *const sys_memory_global_by_current_bytes_column_privileges[] = {
    "select,insert,update,references",
    "select,insert,update,references",
    "select,insert,update,references",
    "select,insert,update,references",
...
static const struct mylite_execution_catalog_mysql_system_table
    sys_summary_memory_system_table_definitions[] = {
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_host_by_current_bytes_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_host_by_current_bytes_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_host_by_current_bytes_column_privileges),
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_thread_by_current_bytes_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_thread_by_current_bytes_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_thread_by_current_bytes_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_user_by_current_bytes_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_user_by_current_bytes_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_by_user_by_current_bytes_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         ...
         0U},
        {"sys",
         {MYLITE_EXECUTION_CATALOG_TABLE_SYS_MEMORY_GLOBAL_BY_CURRENT_BYTES,
          "memory_global_by_current_bytes",
          sys_memory_global_by_current_bytes_columns,
          sizeof(sys_memory_global_by_current_bytes_columns) /
              sizeof(sys_memory_global_by_current_bytes_columns[0])},
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_by_current_bytes_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_by_current_bytes_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_by_current_bytes_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
        ...
        {"sys",
         ...
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_total_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_total_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_total_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
         NULL,
         0U,
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
...
static const struct mylite_execution_catalog_mysql_system_table
    sys_summary_memory_x_system_table_definitions[] = {
        ...
        {"sys",
         ...
         0U},
        {"sys",
         {MYLITE_EXECUTION_CATALOG_TABLE_SYS_X_MEMORY_GLOBAL_BY_CURRENT_BYTES,
          "x$memory_global_by_current_bytes",
          sys_x_memory_global_by_current_bytes_columns,
          sizeof(sys_x_memory_global_by_current_bytes_columns) /
              sizeof(sys_x_memory_global_by_current_bytes_columns[0])},
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_by_current_bytes_column_keys),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_by_current_bytes_column_extras),
         MYLITE_EXECUTION_CATALOG_ARRAY(sys_memory_global_by_current_bytes_column_privileges),
         MYLITE_EXECUTION_CATALOG_NO_ARRAY,
