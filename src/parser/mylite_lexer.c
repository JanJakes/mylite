...
static int keyword_token(const MyliteToken *token) {
  static const struct {
    ...
    int token;
      ...
      {"ASC", ML_ASC},
      {"AS", ML_AS},
      {"ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS", ML_ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS},
      {"AT", ML_AT},
      {"AUTO", ML_AUTO},
      ...
      {"GET", ML_GET},
      {"GET_MASTER_PUBLIC_KEY", ML_GET_MASTER_PUBLIC_KEY},
      {"GET_SOURCE_PUBLIC_KEY", ML_GET_SOURCE_PUBLIC_KEY},
      {"GLOBAL", ML_GLOBAL},
      {"GRANT", ML_GRANT},
      {"GRANTS", ML_GRANTS},
      {"GROUP", ML_GROUP},
      {"GROUP_REPLICATION", ML_GROUP_REPLICATION},
      {"GTID_ONLY", ML_GTID_ONLY},
      {"GTIDS", ML_GTIDS},
      {"HANDLER", ML_HANDLER},
      {"HAVING", ML_HAVING},
      {"HELP", ML_HELP},
      ...
      {"IF", ML_IF},
      {"IGNORE", ML_IGNORE},
      {"IGNORE_SERVER_IDS", ML_IGNORE_SERVER_IDS},
      ...
      {"MANUAL", ML_MANUAL},
      {"MASTER", ML_MASTER},
      {"MASTER_AUTO_POSITION", ML_MASTER_AUTO_POSITION},
      {"MASTER_BIND", ML_MASTER_BIND},
      {"MASTER_COMPRESSION_ALGORITHMS", ML_MASTER_COMPRESSION_ALGORITHMS},
      {"MASTER_CONNECT_RETRY", ML_MASTER_CONNECT_RETRY},
      {"MASTER_DELAY", ML_MASTER_DELAY},
      {"MASTER_HEARTBEAT_PERIOD", ML_MASTER_HEARTBEAT_PERIOD},
      {"MASTER_HOST", ML_MASTER_HOST},
      {"MASTER_LOG_FILE", ML_MASTER_LOG_FILE},
      {"MASTER_LOG_POS", ML_MASTER_LOG_POS},
      {"MASTER_PASSWORD", ML_MASTER_PASSWORD},
      {"MASTER_PORT", ML_MASTER_PORT},
      {"MASTER_PUBLIC_KEY_PATH", ML_MASTER_PUBLIC_KEY_PATH},
      {"MASTER_RETRY_COUNT", ML_MASTER_RETRY_COUNT},
      {"MASTER_SSL", ML_MASTER_SSL},
      {"MASTER_SSL_CA", ML_MASTER_SSL_CA},
      {"MASTER_SSL_CAPATH", ML_MASTER_SSL_CAPATH},
      {"MASTER_SSL_CERT", ML_MASTER_SSL_CERT},
      {"MASTER_SSL_CIPHER", ML_MASTER_SSL_CIPHER},
      {"MASTER_SSL_CRL", ML_MASTER_SSL_CRL},
      {"MASTER_SSL_CRLPATH", ML_MASTER_SSL_CRLPATH},
      {"MASTER_SSL_KEY", ML_MASTER_SSL_KEY},
      {"MASTER_SSL_VERIFY_SERVER_CERT", ML_MASTER_SSL_VERIFY_SERVER_CERT},
      {"MASTER_TLS_CIPHERSUITES", ML_MASTER_TLS_CIPHERSUITES},
      {"MASTER_TLS_VERSION", ML_MASTER_TLS_VERSION},
      {"MASTER_USER", ML_MASTER_USER},
      {"MASTER_ZSTD_COMPRESSION_LEVEL", ML_MASTER_ZSTD_COMPRESSION_LEVEL},
      ...
      {"NAMES", ML_NAMES},
      {"NEVER", ML_NEVER},
      {"NETWORK_NAMESPACE", ML_NETWORK_NAMESPACE},
      {"NEXT", ML_NEXT},
      ...
      {"PRIVILEGE_CHECKS_USER", ML_PRIVILEGE_CHECKS_USER},
      {"PRIMARY", ML_PRIMARY},
      ...
      {"REQUIRE", ML_REQUIRE},
      {"REQUIRE_ROW_FORMAT", ML_REQUIRE_ROW_FORMAT},
      {"REQUIRE_TABLE_PRIMARY_KEY_CHECK", ML_REQUIRE_TABLE_PRIMARY_KEY_CHECK},
      {"REPEAT", ML_REPEAT},
      ...
      {"SECONDARY_LOAD", ML_SECONDARY_LOAD},
      {"SECONDARY_UNLOAD", ML_SECONDARY_UNLOAD},
      {"SET", ML_SET},
      {"SESSION", ML_SESSION},
      ...
      {"SONAME", ML_SONAME},
      {"SOURCE", ML_SOURCE},
      {"SOURCE_AUTO_POSITION", ML_SOURCE_AUTO_POSITION},
      {"SOURCE_BIND", ML_SOURCE_BIND},
      {"SOURCE_COMPRESSION_ALGORITHMS", ML_SOURCE_COMPRESSION_ALGORITHMS},
      {"SOURCE_CONNECT_RETRY", ML_SOURCE_CONNECT_RETRY},
      {"SOURCE_CONNECTION_AUTO_FAILOVER", ML_SOURCE_CONNECTION_AUTO_FAILOVER},
      {"SOURCE_DELAY", ML_SOURCE_DELAY},
      {"SOURCE_HEARTBEAT_PERIOD", ML_SOURCE_HEARTBEAT_PERIOD},
      {"SOURCE_HOST", ML_SOURCE_HOST},
      {"SOURCE_LOG_FILE", ML_SOURCE_LOG_FILE},
      {"SOURCE_LOG_POS", ML_SOURCE_LOG_POS},
      {"SOURCE_PASSWORD", ML_SOURCE_PASSWORD},
      {"SOURCE_PORT", ML_SOURCE_PORT},
      {"SOURCE_PUBLIC_KEY_PATH", ML_SOURCE_PUBLIC_KEY_PATH},
      {"SOURCE_RETRY_COUNT", ML_SOURCE_RETRY_COUNT},
      {"SOURCE_SSL", ML_SOURCE_SSL},
      {"SOURCE_SSL_CA", ML_SOURCE_SSL_CA},
      {"SOURCE_SSL_CAPATH", ML_SOURCE_SSL_CAPATH},
      {"SOURCE_SSL_CERT", ML_SOURCE_SSL_CERT},
      {"SOURCE_SSL_CIPHER", ML_SOURCE_SSL_CIPHER},
      {"SOURCE_SSL_CRL", ML_SOURCE_SSL_CRL},
      {"SOURCE_SSL_CRLPATH", ML_SOURCE_SSL_CRLPATH},
      {"SOURCE_SSL_KEY", ML_SOURCE_SSL_KEY},
      {"SOURCE_SSL_VERIFY_SERVER_CERT", ML_SOURCE_SSL_VERIFY_SERVER_CERT},
      {"SOURCE_TLS_CIPHERSUITES", ML_SOURCE_TLS_CIPHERSUITES},
      {"SOURCE_TLS_VERSION", ML_SOURCE_TLS_VERSION},
      {"SOURCE_USER", ML_SOURCE_USER},
      {"SOURCE_ZSTD_COMPRESSION_LEVEL", ML_SOURCE_ZSTD_COMPRESSION_LEVEL},
