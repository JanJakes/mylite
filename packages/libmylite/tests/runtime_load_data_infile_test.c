...
static int expect_load_ok(
    ...
    failures +=
        mylite_test_expect_size(mylite_result_column_count(result), 0U, "load data column count");
    failures += mylite_test_expect_size(mylite_result_row_count(result), 0U, "load data row count");
