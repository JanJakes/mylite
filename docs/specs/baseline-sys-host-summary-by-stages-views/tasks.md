# Baseline sys.host_summary_by_stages views tasks

- [x] Record official MySQL 8.4 documentation references for the sys host
      summary by stage view surface, Performance Schema stage-summary
...
- [x] Specify empty placeholder behavior and intentionally unsupported live
      host/stage summary and formatting-function behavior.
