...
enum mylite_sql_ast_node_kind {
    ...
    MYLITE_SQL_AST_WINDOW_SPEC = 623,
    MYLITE_SQL_AST_WINDOW_PARTITION_CLAUSE = 624,
    MYLITE_SQL_AST_WINDOW_ORDER_CLAUSE = 625,
    MYLITE_SQL_AST_REGEXP_INSTR_FUNCTION = 626,
    MYLITE_SQL_AST_REGEXP_INSTR_ARGUMENT_COUNT_ERROR = 627,
    MYLITE_SQL_AST_REGEXP_SUBSTR_FUNCTION = 628,
    MYLITE_SQL_AST_REGEXP_SUBSTR_ARGUMENT_COUNT_ERROR = 629,
    MYLITE_SQL_AST_REGEXP_REPLACE_FUNCTION = 630,
    MYLITE_SQL_AST_REGEXP_REPLACE_ARGUMENT_COUNT_ERROR = 631,
    MYLITE_SQL_AST_SOUNDEX_FUNCTION = 632,
    MYLITE_SQL_AST_SOUNDEX_ARGUMENT_COUNT_ERROR = 633,
    MYLITE_SQL_AST_CHECKSUM_TABLE_STATEMENT = 634,
    MYLITE_SQL_AST_COLLATE_EXPRESSION = 635,
    MYLITE_SQL_AST_MULTI_VALUED_INDEX_PART = 636,
    MYLITE_SQL_AST_CONVERT_TZ_FUNCTION = 637,
    MYLITE_SQL_AST_CONVERT_TZ_ARGUMENT_COUNT_ERROR = 638,
    MYLITE_SQL_AST_PERIOD_ADD_FUNCTION = 639,
    MYLITE_SQL_AST_PERIOD_ADD_ARGUMENT_COUNT_ERROR = 640,
    MYLITE_SQL_AST_PERIOD_DIFF_FUNCTION = 641,
    MYLITE_SQL_AST_PERIOD_DIFF_ARGUMENT_COUNT_ERROR = 642,
    MYLITE_SQL_AST_WEIGHT_STRING_FUNCTION = 643,
    MYLITE_SQL_AST_WEIGHT_STRING_BINARY_FUNCTION = 644,
};
