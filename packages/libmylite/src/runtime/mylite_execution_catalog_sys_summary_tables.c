...
static const struct mylite_execution_catalog_sys_summary_system_table_provider
    sys_summary_system_table_providers[] = {
        ...
        {mylite_execution_catalog_sys_summary_wait_system_table_definition_count,
         mylite_execution_catalog_sys_summary_wait_system_table_definition_at},
...
static const struct mylite_execution_catalog_sys_summary_system_table_provider
    sys_summary_x_system_table_providers[] = {
        ...
        {mylite_execution_catalog_sys_summary_wait_x_system_table_definition_count,
         mylite_execution_catalog_sys_summary_wait_x_system_table_definition_at},
