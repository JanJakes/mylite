...
static const struct mylite_execution_catalog_mysql_system_table
    sys_summary_statement_system_table_definitions[] = {
        {"sys",
         ...
         sys_statement_analysis_column_keys,
         sys_statement_analysis_column_extras,
         sys_statement_analysis_column_privileges,
         NULL,
         NULL,
         0U,
         NULL,
        ...
        {"sys",
         ...
         sys_statements_with_errors_or_warnings_column_keys,
         sys_statements_with_errors_or_warnings_column_extras,
         sys_statements_with_errors_or_warnings_column_privileges,
         NULL,
         NULL,
         0U,
         NULL,
        ...
        {"sys",
         ...
         sys_statements_with_full_table_scans_column_keys,
         sys_statements_with_full_table_scans_column_extras,
         sys_statements_with_full_table_scans_column_privileges,
         NULL,
         NULL,
         0U,
         NULL,
...
static const struct mylite_execution_catalog_mysql_system_table
    sys_summary_statement_x_system_table_definitions[] = {
        {"sys",
         ...
         sys_x_statement_analysis_column_keys,
         sys_x_statement_analysis_column_extras,
         sys_x_statement_analysis_column_privileges,
         NULL,
         NULL,
         0U,
         NULL,
