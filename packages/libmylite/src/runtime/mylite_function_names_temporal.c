...
bool mylite_function_name_is_str_to_date(const struct mylite_sql_ast_node *name) {
    static const char *const names[] = {"STR_TO_DATE"};
...
bool mylite_function_name_is_timediff(const struct mylite_sql_ast_node *name) {
    static const char *const names[] = {"TIMEDIFF"};
...
bool mylite_function_name_is_addsubtime(const struct mylite_sql_ast_node *name) {
    static const char *const names[] = {"ADDTIME", "SUBTIME"};

    return mylite_function_name_matches_any(name, names, sizeof(names) / sizeof(names[0]));
}

bool mylite_function_name_is_week(const struct mylite_sql_ast_node *name) {
    static const char *const names[] = {"WEEK"};
