# Baseline mysql.component Table Tasks
...
- [x] Add the MySQL-runtime expectation script for the supported component
      table surface.
- [x] Implement MyLite-owned `mysql.component` definition, empty reads, and
