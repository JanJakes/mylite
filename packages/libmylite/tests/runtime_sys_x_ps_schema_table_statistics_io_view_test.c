...
static int test_sys_x_ps_schema_table_statistics_io_view(void);
...
static const char *const
    sys_x_ps_schema_table_statistics_io_columns[sys_x_ps_schema_table_statistics_io_column_count] =
        {
            "table_schema",
            "table_name",
            "count_read",
...
int main(void) {
    return test_sys_x_ps_schema_table_statistics_io_view() == 0 ? 0 : 1;
}
...
static int test_sys_x_ps_schema_table_statistics_io_view(void) {
    ...
    static const char *const app_table_values[] = {
        "app", "base_one", "0", "0", "0", "0", "0", "0", "0", "0",
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT * FROM sys.`x$ps_schema_table_statistics_io` "
                   "WHERE table_schema = 'app' ORDER BY table_name",
            .column_names = sys_x_ps_schema_table_statistics_io_columns,
            .column_count = sys_x_ps_schema_table_statistics_io_column_count,
            .values = app_table_values,
            .row_count = 2U,
            .context = "sys.x ps schema table statistics io app rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io mysql row",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io sys_config row",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io row_count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM sys.`x$ps_schema_table_statistics_io` "
                   "WHERE table_schema = 'app'",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_two,
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io app count",
        }
    );
    ...
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SELECT COUNT(*) FROM `x$ps_schema_table_statistics_io` "
                   "WHERE table_schema = 'app'",
            .column_names = count_column,
            .column_count = 1U,
            .values = count_two,
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io selected schema count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW COLUMNS FROM `x$ps_schema_table_statistics_io`",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = show_columns_values,
            .row_count = sys_x_ps_schema_table_statistics_io_column_count,
            .context = "sys.x ps schema table statistics io show columns",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "DESCRIBE `x$ps_schema_table_statistics_io`",
            .column_names = show_columns_columns,
            .column_count = show_columns_column_count,
            .values = show_columns_values,
            .row_count = sys_x_ps_schema_table_statistics_io_column_count,
            .context = "sys.x ps schema table statistics io describe",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW FULL COLUMNS FROM `x$ps_schema_table_statistics_io` WHERE Field IN "
                   "('table_schema', 'count_read', 'sum_number_of_bytes_read', "
                   "'sum_timer_misc')",
            .column_names = show_full_columns_columns,
            .column_count = show_full_columns_column_count,
            .values = show_full_columns_values,
            .row_count = 4U,
            .context = "sys.x ps schema table statistics io show full columns sample",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW INDEX FROM `x$ps_schema_table_statistics_io`",
            .column_names = show_index_columns,
            .column_count = show_index_column_count,
            .values = NULL,
            .row_count = 0U,
            .context = "sys.x ps schema table statistics io show index",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .context = "sys.x ps schema table statistics io information_schema.columns rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_ten,
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io information_schema.columns count",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io information_schema.tables row",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            .sql = "SHOW TABLE STATUS FROM sys WHERE Name = 'x$ps_schema_table_statistics_io'",
            .column_names = show_table_status_columns,
            .column_count = show_table_status_column_count,
            .values = show_table_status_values,
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io show table status",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io information_schema.views row",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io view_table_usage row",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .row_count = 2U,
            .context = "sys.x ps schema table statistics io view_routine_usage rows",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io empty statistics",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io empty table constraints",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io empty key column usage",
        }
    );
    failures += expect_query(
        database,
        (struct expected_query){
            ...
            .values = count_zero,
            .row_count = 1U,
            .context = "sys.x ps schema table statistics io empty constraint extensions",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE VIEW `x$ps_schema_table_statistics_io`",
            ...
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `x$ps_schema_table_statistics_io`",
            .context = "sys.x ps schema table statistics io show create view",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            ...
            .row_index = 0U,
            .column_index = 1U,
            .needle = "from `performance_schema`.`file_summary_by_instance` group by "
                      "`table_schema`,`table_name`",
            .context = "sys.x ps schema table statistics io show create source",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE sys.`x$ps_schema_table_statistics_io`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            .column_index = 1U,
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `sys`.`x$ps_schema_table_statistics_io`",
            .context = "sys.x ps schema table statistics io qualified show create table",
        }
    );
    failures += expect_query_contains(
        database,
        (struct expected_query_contains){
            .sql = "SHOW CREATE TABLE `x$ps_schema_table_statistics_io`",
            .column_names = show_create_view_columns,
            .column_count = show_create_view_column_count,
            .row_count = 1U,
            .row_index = 0U,
            ...
            .needle = "CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY "
                      "INVOKER VIEW `x$ps_schema_table_statistics_io`",
            .context = "sys.x ps schema table statistics io selected show create table",
        }
    );
...
static int seed_schema_objects(mylite_db *database) {
    ...
    failures += expect_statement_ok(database, "CREATE TABLE app.base_one (id INT PRIMARY KEY)");
    failures += expect_statement_ok(database, "CREATE TABLE app.base_two (id INT)");
    return failures;
}
...
static int make_test_path(char *path, size_t path_size, const char *name) {
    int written = snprintf(
        path,
        path_size,
        "/tmp/mylite_runtime_sys_x_ps_schema_table_statistics_io_view_%d_%s.mylite",
        current_process_id(),
        name
    );
