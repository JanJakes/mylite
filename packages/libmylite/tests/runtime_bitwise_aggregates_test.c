...
static int test_bitwise_values_persistence_rename_and_drop(void);
static int test_bitwise_diagnostics(void);
static int test_independent_bitwise_handles(void);
static int seed_schema(mylite_db *database, const char *name);
static int create_bitwise_table(mylite_db *database, const char *table_name);
...
static int expect_bitwise_query(mylite_db *database, struct expected_bitwise_query query);
...
int main(void) {
    ...
    failures += test_bitwise_values_persistence_rename_and_drop();
    failures += test_bitwise_diagnostics();
    failures += test_independent_bitwise_handles();
...
static int test_bitwise_values_persistence_rename_and_drop(void) {
    ...
    failures += create_bitwise_table(database, "numbers");
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(i) FROM numbers",
            .column = "BIT_AND(i)",
            .value = "0",
            .context = "signed int bit and",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT ALL BIT_OR(i) FROM numbers",
            .column = "BIT_OR(i)",
            .value = "18446744073709551614",
            .context = "all signed int bit or",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(i) FROM numbers",
            .column = "BIT_XOR(i)",
            .value = "2147483642",
            .context = "signed int bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(ii) FROM numbers",
            .column = "BIT_AND(ii)",
            .value = "4",
            .context = "integer alias bit and",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(ii) FROM numbers",
            .column = "BIT_XOR(ii)",
            .value = "18446744073709551614",
            .context = "integer alias bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(iu) FROM numbers",
            .column = "BIT_AND(iu)",
            .value = "0",
            .context = "unsigned int bit and",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(iu) FROM numbers",
            .column = "BIT_OR(iu)",
            .value = "4294967295",
            .context = "unsigned int bit or",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(iu) FROM numbers",
            .column = "BIT_XOR(iu)",
            .value = "4294967293",
            .context = "unsigned int bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(integeru) FROM numbers",
            .column = "BIT_OR(integeru)",
            .value = "3",
            .context = "integer unsigned alias bit or",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(b) FROM numbers",
            .column = "BIT_AND(b)",
            .value = "0",
            .context = "bigint bit and",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(b) FROM numbers",
            .column = "BIT_OR(b)",
            .value = "18446744073709551614",
            .context = "bigint bit or",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(b) FROM numbers",
            .column = "BIT_XOR(b)",
            .value = "9223372036854775802",
            .context = "bigint bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(bu) FROM numbers",
            .column = "BIT_OR(bu)",
            .value = "9223372036854775807",
            .context = "bigint unsigned physical bit or",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(bu) FROM numbers",
            .column = "BIT_XOR(bu)",
            .value = "9223372036854775805",
            .context = "bigint unsigned physical bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(ti) FROM numbers",
            .column = "BIT_OR(ti)",
            .value = "18446744073709551615",
            .context = "tinyint signed bit or",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(ti1) FROM numbers",
            .column = "BIT_XOR(ti1)",
            .value = "0",
            .context = "tinyint display-width bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(si) FROM numbers",
            .column = "BIT_XOR(si)",
            .value = "18446744073709551615",
            .context = "smallint signed pair bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(mi) FROM numbers",
            .column = "BIT_XOR(mi)",
            .value = "18446744073709551615",
            .context = "mediumint signed pair bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(bool_col) FROM numbers",
            .column = "BIT_XOR(bool_col)",
            .value = "1",
            .context = "bool alias bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(boolean_col) FROM numbers",
            .column = "BIT_XOR(boolean_col)",
            .value = "0",
            .context = "boolean alias bit xor",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(n) FROM empty_numbers",
            .column = "BIT_AND(n)",
            .value = "18446744073709551615",
            .context = "empty table bit and neutral",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(n) FROM all_null_numbers",
            .column = "BIT_OR(n)",
            .value = "0",
            .context = "all null bit or neutral",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(n) FROM all_null_numbers",
            .column = "BIT_XOR(n)",
            .value = "0",
            .context = "all null bit xor neutral",
        }
    );
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT bit_and(n) FROM numbers",
            .column = "bit_and(n)",
            .value = "20",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT (BIT_OR(n)) FROM numbers",
            .column = "(BIT_OR(n))",
            .value = "30",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(n) AS mask FROM numbers",
            .column = "mask",
            .value = "30",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(nums.n) FROM numbers AS nums",
            .column = "BIT_OR(nums.n)",
            .value = "30",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(numbers.n) FROM numbers",
            .column = "BIT_OR(numbers.n)",
            .value = "30",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(app.numbers.n) FROM app.numbers",
            .column = "BIT_OR(app.numbers.n)",
            .value = "30",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(`weird name`) FROM numbers",
            .column = "BIT_OR(`weird name`)",
            .value = "7",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(`double\"quote`) FROM numbers",
            .column = "BIT_XOR(`double\"quote`)",
            .value = "1",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(tie) FROM numbers",
            .column = "BIT_XOR(tie)",
            .value = "0",
            .context = "explicit invisible column bit xor",
        }
    );
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(i) FROM numbers WHERE id > 99",
            .column = "BIT_AND(i)",
            .value = "18446744073709551615",
            .context = "no matched rows bit and neutral",
        }
    );
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(id) FROM numbers WHERE n IS NULL",
            .column = "BIT_OR(id)",
            .value = "1",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(n) FROM numbers WHERE n IS NOT NULL",
            .column = "BIT_XOR(n)",
            .value = "30",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(i) FROM numbers WHERE id <> 1",
            .column = "BIT_OR(i)",
            .value = "18446744073709551614",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(n) FROM numbers WHERE id <=> 2",
            .column = "BIT_AND(n)",
            .value = "20",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(id) FROM numbers WHERE i = -2147483648",
            .column = "BIT_XOR(id)",
            .value = "1",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_XOR(id) FROM numbers WHERE b = -9223372036854775808",
            .column = "BIT_XOR(id)",
            .value = "1",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(iu) FROM numbers WHERE iu = 4294967295",
            .column = "BIT_OR(iu)",
            .value = "4294967295",
    ...
    failures += expect_row_count(database, "-1", "row count after bitwise aggregate result set");
    catalog = mylite_connection_catalog_for_test(database);
    session = mylite_connection_session_state(database);
    if (catalog != NULL) {
        failures += expect_size(
            ...
            "bitwise aggregate leaves catalog generation"
        );
    }
    if (session != NULL) {
        failures += expect_size(
            ...
            "bitwise aggregate leaves SQLite schema generation"
        );
    }
    ...
    failures += expect_bytes(
        ...
        "preamble after bitwise aggregate reads"
    );
    ...
    failures += expect_bitwise_query(
        ...
        (struct expected_bitwise_query){
            ...
            .column = "BIT_OR(n)",
            .value = "30",
            .context = "reopened bitwise aggregate",
        }
    );
    failures += execute_ok(database, "RENAME TABLE numbers TO bit_numbers", &result);
    mylite_result_free(result);
    result = NULL;
    failures += execute_error(
        database,
        "SELECT BIT_OR(n) FROM numbers",
        (struct expected_sql_error){
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_OR(n) FROM bit_numbers",
            .column = "BIT_OR(n)",
            .value = "30",
            .context = "renamed source bitwise aggregate",
        }
    );
    failures += execute_ok(database, "TRUNCATE TABLE bit_numbers", &result);
    mylite_result_free(result);
    result = NULL;
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(n) FROM bit_numbers",
            .column = "BIT_AND(n)",
            .value = "18446744073709551615",
            .context = "truncated source bit and neutral",
        }
    );
    failures += execute_ok(database, "DROP TABLE bit_numbers", &result);
    mylite_result_free(result);
    result = NULL;
    failures += execute_error(
        database,
        "SELECT BIT_OR(n) FROM bit_numbers",
        (struct expected_sql_error){
            .code = mysql_error_table_does_not_exist,
            .sqlstate = "42S02",
            .message_part = "Table 'app.bit_numbers' doesn't exist",
        }
    );
...
static int test_bitwise_diagnostics(void) {
    ...
    failures += execute_error(
        database,
        "SELECT BIT_AND(i) FROM missing_schema.numbers",
        (struct expected_sql_error){
    ...
    failures += execute_error(
        database,
        "SELECT BIT_AND(i) FROM _mylite_reserved.numbers",
        (struct expected_sql_error){
    ...
    failures += execute_error(
        database,
        "SELECT BIT_AND(i) FROM _mylite_reserved",
        (struct expected_sql_error){
    ...
    failures += execute_error(
        database,
        "SELECT BIT_AND(missing) FROM numbers",
        (struct expected_sql_error){
    ...
    failures += execute_error(
        database,
        "SELECT BIT_AND(i) FROM numbers WHERE missing = 1",
        (struct expected_sql_error){
            .code = mysql_error_unknown_column,
            .sqlstate = "42S22",
    ...
    failures += execute_error(
        database,
        "SELECT BIT_AND(i) FROM numbers ORDER BY id",
        (struct expected_sql_error){
            .code = mysql_error_parse,
            .sqlstate = "42000",
    ...
    failures += execute_error(
        database,
        "SELECT BIT_XOR(DISTINCT i) FROM numbers",
        (struct expected_sql_error){
            .code = mysql_error_parse,
            .sqlstate = "42000",
            .message_part = "SQL syntax",
    ...
    failures += expect_bitwise_query(
        database,
        (struct expected_bitwise_query){
            .sql = "SELECT BIT_AND(i) AS mask FROM numbers",
            .column = "mask",
            .value = "0",
            .context = "bitwise aggregate select item alias after diagnostics",
        }
    );
...
static int test_independent_bitwise_handles(void) {
    ...
    mylite_result_free(result);
    result = NULL;
    failures += create_bitwise_table(first, "numbers");
    ...
    failures += expect_bitwise_query(
        ...
        (struct expected_bitwise_query){
            ...
            .column = "BIT_OR(n)",
            .value = "30",
            .context = "first handle bitwise aggregate",
        }
    );
    failures += expect_bitwise_query(
        second,
        (struct expected_bitwise_query){
            ...
            .column = "BIT_OR(n)",
            .value = "236",
            .context = "second handle bitwise aggregate",
        }
    );
...
static int create_bitwise_table(mylite_db *database, const char *table_name) {
    ...
    written = snprintf(
        ...
        "(1, -2147483648, -3, 0, 1, -9223372036854775808, 0, "
        "-128, 0, -32768, -8388608, FALSE, TRUE, NULL, 5, 1, 2, 3), "
        "(2, -2, 5, 2, 2, -2, 2, "
        "-1, 1, NULL, NULL, TRUE, FALSE, 20, 6, 1, 3, 4), "
        "(3, 4, 6, 4294967295, 3, 4, 9223372036854775807, "
...
static int make_test_path(char *path, size_t path_size, const char *name) {
    ...
    written = snprintf(
        path,
        path_size,
        "%s/mylite_bitwise_aggregates_%d_%s.mylite",
        directory,
        current_process_id(),
        name
    );
