# Baseline mysql.proxies_priv table tasks
...
- [x] Specify the MyLite scope as an empty read-only metadata placeholder
  without proxy-user grant storage or enforcement.
...
- [x] Implement the `mysql.proxies_priv` table definition and index metadata.
